...
type RdbInstance struct {
	...
	PrivateIps RdbInstancePrivateIpArrayOutput `pulumi:"privateIps"`
...
type rdbInstanceState struct {
	...
	// The private IPv4 address associated with the resource.
	PrivateIps []RdbInstancePrivateIp `pulumi:"privateIps"`
	// List of Private Networks endpoints of the Database Instance.
...
type RdbInstanceState struct {
	...
	// The private IPv4 address associated with the resource.
	PrivateIps RdbInstancePrivateIpArrayInput
	// List of Private Networks endpoints of the Database Instance.
...
// The private IPv4 address associated with the resource.
func (o RdbInstanceOutput) PrivateIps() RdbInstancePrivateIpArrayOutput {
	return o.ApplyT(func(v *RdbInstance) RdbInstancePrivateIpArrayOutput { return v.PrivateIps }).(RdbInstancePrivateIpArrayOutput)
}
...
// The ID of an existing snapshot to restore or create the Database Instance from. Conflicts with the `engine` parameter and backup settings.
func (o RdbInstanceOutput) SnapshotId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *RdbInstance) pulumi.StringPtrOutput { return v.SnapshotId }).(pulumi.StringPtrOutput)
}
