...
//	func main() {
//		pulumi.Run(func(ctx *pulumi.Context) error {
//			mainEdgeServicesPipeline, err := scaleway.NewEdgeServicesPipeline(ctx, "mainEdgeServicesPipeline", &scaleway.EdgeServicesPipelineArgs{
//				Description: pulumi.String("pipeline description"),
//			})
//			if err != nil {
//				return err
//			}
//			mainEdgeServicesBackendStage, err := scaleway.NewEdgeServicesBackendStage(ctx, "mainEdgeServicesBackendStage", &scaleway.EdgeServicesBackendStageArgs{
...
//				return err
//			}
//			mainEdgeServicesWafStage, err := scaleway.NewEdgeServicesWafStage(ctx, "mainEdgeServicesWafStage", &scaleway.EdgeServicesWafStageArgs{
//				PipelineId:     mainEdgeServicesPipeline.ID(),
...
//				return err
//			}
//			mainEdgeServicesRouteStage, err := scaleway.NewEdgeServicesRouteStage(ctx, "mainEdgeServicesRouteStage", &scaleway.EdgeServicesRouteStageArgs{
//				PipelineId: mainEdgeServicesPipeline.ID(),
...
//				return err
//			}
//			mainEdgeServicesCacheStage, err := scaleway.NewEdgeServicesCacheStage(ctx, "mainEdgeServicesCacheStage", &scaleway.EdgeServicesCacheStageArgs{
//				PipelineId:   mainEdgeServicesPipeline.ID(),
...
//				return err
//			}
//			mainEdgeServicesTlsStage, err := scaleway.NewEdgeServicesTlsStage(ctx, "mainEdgeServicesTlsStage", &scaleway.EdgeServicesTlsStageArgs{
//				PipelineId:         mainEdgeServicesPipeline.ID(),
...
//				return err
//			}
//			mainEdgeServicesDnsStage, err := scaleway.NewEdgeServicesDnsStage(ctx, "mainEdgeServicesDnsStage", &scaleway.EdgeServicesDnsStageArgs{
//				PipelineId: mainEdgeServicesPipeline.ID(),
...
//				return err
//			}
//			_, err = scaleway.NewEdgeServicesHeadStage(ctx, "mainEdgeServicesHeadStage", &scaleway.EdgeServicesHeadStageArgs{
//				PipelineId:  mainEdgeServicesPipeline.ID(),
