...
//				return err
//			}
//			_, err = scaleway.NewBaremetalServer(ctx, "myServer", &scaleway.BaremetalServerArgs{
...
//				return err
//			}
//			mySshKey, err := scaleway.NewIamSshKey(ctx, "mySshKey", &scaleway.IamSshKeyArgs{
...
// You cannot directly modify the subscriptionPeriod of an existing getBaremetalOffer resource. Instead, you must define the monthly offer using the data source and then update the server configuration accordingly.
//
// ### Hourly Plan Example
//
// ```go
