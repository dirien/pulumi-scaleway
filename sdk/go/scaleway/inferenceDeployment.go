...
type InferenceDeployment struct {
	...
	PrivateIps InferenceDeploymentPrivateIpArrayOutput `pulumi:"privateIps"`
...
type inferenceDeploymentState struct {
	...
	// The private IPv4 address associated with the deployment.
	PrivateIps []InferenceDeploymentPrivateIp `pulumi:"privateIps"`
	// `projectId`) The ID of the project the deployment is associated with.
...
type InferenceDeploymentState struct {
	...
	// The private IPv4 address associated with the deployment.
	PrivateIps InferenceDeploymentPrivateIpArrayInput
	// `projectId`) The ID of the project the deployment is associated with.
...
// The maximum size of the pool.
func (o InferenceDeploymentOutput) MaxSize() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *InferenceDeployment) pulumi.IntPtrOutput { return v.MaxSize }).(pulumi.IntPtrOutput)
}

// The minimum size of the pool.
func (o InferenceDeploymentOutput) MinSize() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *InferenceDeployment) pulumi.IntPtrOutput { return v.MinSize }).(pulumi.IntPtrOutput)
}
...
// The private IPv4 address associated with the deployment.
func (o InferenceDeploymentOutput) PrivateIps() InferenceDeploymentPrivateIpArrayOutput {
	return o.ApplyT(func(v *InferenceDeployment) InferenceDeploymentPrivateIpArrayOutput { return v.PrivateIps }).(InferenceDeploymentPrivateIpArrayOutput)
}
...
// The number of bits each model parameter should be quantized to
func (o InferenceDeploymentOutput) Quantization() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *InferenceDeployment) pulumi.IntPtrOutput { return v.Quantization }).(pulumi.IntPtrOutput)
}
