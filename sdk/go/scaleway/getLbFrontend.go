...
func (o LookupLbFrontendResultOutput) ConnectionRateLimit() pulumi.IntOutput {
	return o.ApplyT(func(v LookupLbFrontendResult) int { return v.ConnectionRateLimit }).(pulumi.IntOutput)
}
