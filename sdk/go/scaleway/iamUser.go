...
//			_, err := scaleway.NewIamUser(ctx, "user", &scaleway.IamUserArgs{
...
//				},
//			}
//			var usersIamUser []*scaleway.IamUser
//			for index := 0; index < len(users); index++ {
//				key0 := index
//				val0 := index
//				__res, err := scaleway.NewIamUser(ctx, fmt.Sprintf("usersIamUser-%v", key0), &scaleway.IamUserArgs{
...
//					return err
//				}
//				usersIamUser = append(usersIamUser, __res)
//			}
//			return nil
//		})
//	}
