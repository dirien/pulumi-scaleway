...
//				return err
//			}
//			fromSnapshotBlockVolume, err := scaleway.NewBlockVolume(ctx, "fromSnapshotBlockVolume", &scaleway.BlockVolumeArgs{
...
//				Type: pulumi.String("PRO2-XXS"),
//				RootVolume: &scaleway.InstanceServerRootVolumeArgs{
//					VolumeId:   fromSnapshotBlockVolume.ID(),
...
// Mandatory for Windows OS. The publicKey value of this key is used to encrypt the admin password.
// When set to an empty string, it resets this value and adminPasswordEncryptedValue to an empty string so a new password may be generated.
func (o InstanceServerOutput) AdminPasswordEncryptionSshKeyId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *InstanceServer) pulumi.StringPtrOutput { return v.AdminPasswordEncryptionSshKeyId }).(pulumi.StringPtrOutput)
}
