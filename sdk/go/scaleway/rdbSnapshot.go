...
//	func main() {
//		pulumi.Run(func(ctx *pulumi.Context) error {
//			_, err := scaleway.NewRdbSnapshot(ctx, "snapshotWithExpiration", &scaleway.RdbSnapshotArgs{
...
//	func main() {
//		pulumi.Run(func(ctx *pulumi.Context) error {
//			_, err := scaleway.NewRdbSnapshot(ctx, "snapshotA", &scaleway.RdbSnapshotArgs{
//				InstanceId: pulumi.Any(scaleway_rdb_instance.Main.Id),
//			}, pulumi.DependsOn([]pulumi.Resource{
...
//				return err
//			}
//			_, err = scaleway.NewRdbSnapshot(ctx, "snapshotB", &scaleway.RdbSnapshotArgs{
//				InstanceId: pulumi.Any(scaleway_rdb_instance.Main.Id),
