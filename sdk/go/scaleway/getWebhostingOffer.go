...
type GetWebhostingOfferResult struct {
	...
	Offers []GetWebhostingOfferOffer `pulumi:"offers"`
	// The offer price.
...
func GetWebhostingOfferOutput(ctx *pulumi.Context, args GetWebhostingOfferOutputArgs, opts ...pulumi.InvokeOption) GetWebhostingOfferResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetWebhostingOfferResultOutput, error) {
			args := v.(GetWebhostingOfferArgs)
			options := pulumi.InvokeOutputOptions{InvokeOptions: internal.PkgInvokeDefaultOpts(opts)}
			return ctx.InvokeOutput("scaleway:index/getWebhostingOffer:getWebhostingOffer", args, GetWebhostingOfferResultOutput{}, options).(GetWebhostingOfferResultOutput), nil
...
func (o GetWebhostingOfferResultOutput) ControlPanel() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetWebhostingOfferResult) *string { return v.ControlPanel }).(pulumi.StringPtrOutput)
}
...
// The detailed offer of the hosting.
func (o GetWebhostingOfferResultOutput) Offers() GetWebhostingOfferOfferArrayOutput {
	return o.ApplyT(func(v GetWebhostingOfferResult) []GetWebhostingOfferOffer { return v.Offers }).(GetWebhostingOfferOfferArrayOutput)
}
