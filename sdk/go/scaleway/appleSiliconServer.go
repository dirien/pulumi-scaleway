...
type AppleSiliconServer struct {
	...
	PrivateIps AppleSiliconServerPrivateIpArrayOutput `pulumi:"privateIps"`
...
type appleSiliconServerState struct {
	...
	// The list of private IPv4 and IPv6 addresses associated with the server.
	PrivateIps []AppleSiliconServerPrivateIp `pulumi:"privateIps"`
	// The private networks to attach to the server
...
type AppleSiliconServerState struct {
	...
	// The list of private IPv4 and IPv6 addresses associated with the server.
	PrivateIps AppleSiliconServerPrivateIpArrayInput
	// The private networks to attach to the server
...
// The list of private IPv4 and IPv6 addresses associated with the server.
func (o AppleSiliconServerOutput) PrivateIps() AppleSiliconServerPrivateIpArrayOutput {
	return o.ApplyT(func(v *AppleSiliconServer) AppleSiliconServerPrivateIpArrayOutput { return v.PrivateIps }).(AppleSiliconServerPrivateIpArrayOutput)
}
