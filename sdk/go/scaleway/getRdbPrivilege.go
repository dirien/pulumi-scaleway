...
func (o LookupRdbPrivilegeResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupRdbPrivilegeResult] {
	return pulumix.Output[LookupRdbPrivilegeResult]{
