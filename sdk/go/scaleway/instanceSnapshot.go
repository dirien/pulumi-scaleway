...
type InstanceSnapshot struct {
	...
	//
	// > **Important:** Snapshots of volumes with type `bSsd` (Block SSD) are deprecated and cannot be managed using the `InstanceSnapshot` resource anymore. Please use the `BlockSnapshot` resource instead.
