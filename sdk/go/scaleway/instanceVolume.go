...
type InstanceVolume struct {
	...
	//
	// > **Important:** Volumes with type `bSsd` (Block SSD) are deprecated and cannot be managed using the `InstanceVolume` resource anymore. Please use the `BlockVolume` resource instead.
