...
//				PipelineId: pulumi.Any(scaleway_edge_services_pipeline.Main.Id),
//				WafStageId: pulumi.Any(scaleway_edge_services_waf_stage.Waf.Id),
//				Rules: scaleway.EdgeServicesRouteStageRuleArray{
//					&scaleway.EdgeServicesRouteStageRuleArgs{
//						BackendStageId: pulumi.Any(scaleway_edge_services_backend_stage.Backend.Id),
