...
type Lb struct {
	...
	PrivateIps LbPrivateIpArrayOutput `pulumi:"privateIps"`
...
type lbState struct {
	...
	// The list of private IPv4 and IPv6 addresses associated with the resource.
	PrivateIps []LbPrivateIp `pulumi:"privateIps"`
	// List of private network to connect with your load balancer.
...
type LbState struct {
	...
	// The list of private IPv4 and IPv6 addresses associated with the resource.
	PrivateIps LbPrivateIpArrayInput
	// List of private network to connect with your load balancer.
...
// The list of private IPv4 and IPv6 addresses associated with the resource.
func (o LbOutput) PrivateIps() LbPrivateIpArrayOutput {
	return o.ApplyT(func(v *Lb) LbPrivateIpArrayOutput { return v.PrivateIps }).(LbPrivateIpArrayOutput)
}
