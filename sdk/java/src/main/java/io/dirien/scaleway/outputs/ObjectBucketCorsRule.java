...
@CustomType
public final class ObjectBucketCorsRule {
    /**
    ...
    public static Builder builder(ObjectBucketCorsRule defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer maxAgeSeconds;
        public Builder() {}
        public Builder(ObjectBucketCorsRule defaults) {
        ...
        public ObjectBucketCorsRule build() {
            final var o = new ObjectBucketCorsRule();
