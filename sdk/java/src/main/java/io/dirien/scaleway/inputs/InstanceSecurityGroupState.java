...
public final class InstanceSecurityGroupState extends com.pulumi.resources.ResourceArgs {

    public static final InstanceSecurityGroupState Empty = new InstanceSecurityGroupState();
    ...
    private InstanceSecurityGroupState() {}

    private InstanceSecurityGroupState(InstanceSecurityGroupState $) {
    ...
    public static Builder builder(InstanceSecurityGroupState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceSecurityGroupState();
        }

        public Builder(InstanceSecurityGroupState defaults) {
            $ = new InstanceSecurityGroupState(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param organizationId The organization ID the security group is associated with.
         * 
         * @return builder
         * 
         */
        ...
        public InstanceSecurityGroupState build() {
            return $;
        }
    }
