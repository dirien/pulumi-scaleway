...
@CustomType
public final class InstanceSecurityGroupOutboundRule {
    /**
    ...
    public static Builder builder(InstanceSecurityGroupOutboundRule defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String protocol;
        public Builder() {}
        public Builder(InstanceSecurityGroupOutboundRule defaults) {
        ...
        public InstanceSecurityGroupOutboundRule build() {
            final var o = new InstanceSecurityGroupOutboundRule();
            o.action = action;
            o.ip = ip;
            o.ipRange = ipRange;
            o.port = port;
