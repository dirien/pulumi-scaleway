...
import io.dirien.scaleway.inputs.K8sClusterKubeconfigArgs;
...
public final class K8sClusterState extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<List<K8sClusterKubeconfigArgs>> kubeconfigs;

    /**
     * @return The kubeconfig configuration file of the Kubernetes cluster
     * 
     */
    public Optional<Output<List<K8sClusterKubeconfigArgs>>> kubeconfigs() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder kubeconfigs(@Nullable Output<List<K8sClusterKubeconfigArgs>> kubeconfigs) {
         ...
         * 
         */
        public Builder kubeconfigs(List<K8sClusterKubeconfigArgs> kubeconfigs) {
         ...
         * 
         */
        public Builder kubeconfigs(K8sClusterKubeconfigArgs... kubeconfigs) {
