...
import io.dirien.scaleway.FunctionNamespaceArgs;
import io.dirien.scaleway.Utilities;
import io.dirien.scaleway.inputs.FunctionNamespaceState;
 ...
 * 
 */
@ResourceType(type="scaleway:index/functionNamespace:FunctionNamespace")
public class FunctionNamespace extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public FunctionNamespace(String name) {
        this(name, FunctionNamespaceArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public FunctionNamespace(String name, @Nullable FunctionNamespaceArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public FunctionNamespace(String name, @Nullable FunctionNamespaceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("scaleway:index/functionNamespace:FunctionNamespace", name, args == null ? FunctionNamespaceArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private FunctionNamespace(String name, Output<String> id, @Nullable FunctionNamespaceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("scaleway:index/functionNamespace:FunctionNamespace", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static FunctionNamespace get(String name, Output<String> id, @Nullable FunctionNamespaceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
