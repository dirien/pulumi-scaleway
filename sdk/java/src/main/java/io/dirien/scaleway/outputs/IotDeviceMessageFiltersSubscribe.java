...
@CustomType
public final class IotDeviceMessageFiltersSubscribe {
    /**
    ...
    public static Builder builder(IotDeviceMessageFiltersSubscribe defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> topics;
        public Builder() {}
        public Builder(IotDeviceMessageFiltersSubscribe defaults) {
        ...
        public IotDeviceMessageFiltersSubscribe build() {
            final var o = new IotDeviceMessageFiltersSubscribe();
            o.policy = policy;
            o.topics = topics;
            return o;
        }
