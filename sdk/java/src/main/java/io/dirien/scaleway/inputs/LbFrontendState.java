...
public final class LbFrontendState extends com.pulumi.resources.ResourceArgs {

    public static final LbFrontendState Empty = new LbFrontendState();
    ...
    private LbFrontendState() {}

    private LbFrontendState(LbFrontendState $) {
        this.acls = $.acls;
    ...
    public static Builder builder(LbFrontendState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(LbFrontendState defaults) {
            $ = new LbFrontendState(Objects.requireNonNull(defaults));
        }
