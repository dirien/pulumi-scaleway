...
@CustomType
public final class LbFrontendAclActionRedirect {
    /**
    ...
    public static Builder builder(LbFrontendAclActionRedirect defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String type;
        public Builder() {}
        public Builder(LbFrontendAclActionRedirect defaults) {
        ...
        public LbFrontendAclActionRedirect build() {
            final var o = new LbFrontendAclActionRedirect();
            o.code = code;
            o.target = target;
            o.type = type;
            return o;
