...
@CustomType
public final class GetInstanceSecurityGroupOutboundRule {
    /**
    ...
    public static Builder builder(GetInstanceSecurityGroupOutboundRule defaults) {
    ...
    public static final class Builder {
        ...
        private String protocol;
        public Builder() {}
        public Builder(GetInstanceSecurityGroupOutboundRule defaults) {
        ...
        public GetInstanceSecurityGroupOutboundRule build() {
            final var o = new GetInstanceSecurityGroupOutboundRule();
            o.action = action;
            o.ip = ip;
            o.ipRange = ipRange;
            o.port = port;
