...
@CustomType
public final class GetK8sClusterAutoUpgrade {
    /**
    ...
    private GetK8sClusterAutoUpgrade() {}
    /**
     * @return True if Kubernetes patch version auto upgrades is enabled.
     * 
     */
    ...
    public static Builder builder(GetK8sClusterAutoUpgrade defaults) {
    ...
    public static final class Builder {
        ...
        private Integer maintenanceWindowStartHour;
        public Builder() {}
        public Builder(GetK8sClusterAutoUpgrade defaults) {
        ...
        public GetK8sClusterAutoUpgrade build() {
            final var o = new GetK8sClusterAutoUpgrade();
            o.enable = enable;
