...
@CustomType
public final class InstanceSecurityGroupRulesInboundRule {
    /**
    ...
    public static Builder builder(InstanceSecurityGroupRulesInboundRule defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String protocol;
        public Builder() {}
        public Builder(InstanceSecurityGroupRulesInboundRule defaults) {
        ...
        public InstanceSecurityGroupRulesInboundRule build() {
            final var o = new InstanceSecurityGroupRulesInboundRule();
            o.action = action;
            o.ip = ip;
            o.ipRange = ipRange;
            o.port = port;
