...
@CustomType
public final class LbPrivateNetwork {
    /**
    ...
    public static Builder builder(LbPrivateNetwork defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String zone;
        public Builder() {}
        public Builder(LbPrivateNetwork defaults) {
        ...
        public LbPrivateNetwork build() {
            final var o = new LbPrivateNetwork();
