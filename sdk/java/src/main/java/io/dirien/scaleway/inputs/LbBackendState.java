...
public final class LbBackendState extends com.pulumi.resources.ResourceArgs {

    public static final LbBackendState Empty = new LbBackendState();
    ...
    private LbBackendState() {}

    private LbBackendState(LbBackendState $) {
    ...
    public static Builder builder(LbBackendState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(LbBackendState defaults) {
            $ = new LbBackendState(Objects.requireNonNull(defaults));
        }
