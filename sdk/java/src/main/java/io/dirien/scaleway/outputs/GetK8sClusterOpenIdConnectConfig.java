...
@CustomType
public final class GetK8sClusterOpenIdConnectConfig {
    ...
    private GetK8sClusterOpenIdConnectConfig() {}
    ...
    public static Builder builder(GetK8sClusterOpenIdConnectConfig defaults) {
    ...
    public static final class Builder {
        ...
        private String usernamePrefix;
        public Builder() {}
        public Builder(GetK8sClusterOpenIdConnectConfig defaults) {
        ...
        public GetK8sClusterOpenIdConnectConfig build() {
            final var o = new GetK8sClusterOpenIdConnectConfig();
            o.clientId = clientId;
