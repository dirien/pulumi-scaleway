...
import io.dirien.scaleway.inputs.K8sPoolNodeArgs;
...
public final class K8sPoolState extends com.pulumi.resources.ResourceArgs {

    public static final K8sPoolState Empty = new K8sPoolState();
     ...
     */
    @Import(name="nodes")
    private @Nullable Output<List<K8sPoolNodeArgs>> nodes;

    /**
     * @return (List of) The nodes in the default pool.
     * 
     */
    public Optional<Output<List<K8sPoolNodeArgs>>> nodes() {
    ...
    private K8sPoolState() {}

    private K8sPoolState(K8sPoolState $) {
    ...
    public static Builder builder(K8sPoolState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(K8sPoolState defaults) {
            $ = new K8sPoolState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder nodes(@Nullable Output<List<K8sPoolNodeArgs>> nodes) {
            $.nodes = nodes;
            return this;
        }
         ...
         * 
         */
        public Builder nodes(List<K8sPoolNodeArgs> nodes) {
         ...
         * 
         */
        public Builder nodes(K8sPoolNodeArgs... nodes) {
