...
public final class LbRouteArgs extends com.pulumi.resources.ResourceArgs {

    public static final LbRouteArgs Empty = new LbRouteArgs();
    ...
    private LbRouteArgs(LbRouteArgs $) {
    ...
    public static Builder builder(LbRouteArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(LbRouteArgs defaults) {
            $ = new LbRouteArgs(Objects.requireNonNull(defaults));
        }
