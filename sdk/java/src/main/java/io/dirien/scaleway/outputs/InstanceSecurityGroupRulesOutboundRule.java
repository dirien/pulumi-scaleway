...
@CustomType
public final class InstanceSecurityGroupRulesOutboundRule {
    /**
    ...
    public static Builder builder(InstanceSecurityGroupRulesOutboundRule defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String protocol;
        public Builder() {}
        public Builder(InstanceSecurityGroupRulesOutboundRule defaults) {
        ...
        public InstanceSecurityGroupRulesOutboundRule build() {
            final var o = new InstanceSecurityGroupRulesOutboundRule();
            o.action = action;
            o.ip = ip;
            o.ipRange = ipRange;
            o.port = port;
