...
__all__ = [
    'GetVpcPublicGatewayPatRuleResult',
    'AwaitableGetVpcPublicGatewayPatRuleResult',
    'get_vpc_public_gateway_pat_rule',
    'get_vpc_public_gateway_pat_rule_output',
]

@pulumi.output_type
class GetVpcPublicGatewayPatRuleResult:
    """
...
class AwaitableGetVpcPublicGatewayPatRuleResult(GetVpcPublicGatewayPatRuleResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetVpcPublicGatewayPatRuleResult(
...
def get_vpc_public_gateway_pat_rule(pat_rule_id: Optional[builtins.str] = None,
                                    zone: Optional[builtins.str] = None,
                                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetVpcPublicGatewayPatRuleResult:
    """
    ...
    pat01 = scaleway.VpcPublicGatewayPatRule("pat01",
        ...
        public_port=2202,
        protocol="tcp")
    main = scaleway.get_vpc_public_gateway_pat_rule_output(pat_rule_id=pat01.id)
    ```
    ...
    __ret__ = pulumi.runtime.invoke('scaleway:index/getVpcPublicGatewayPatRule:getVpcPublicGatewayPatRule', __args__, opts=opts, typ=GetVpcPublicGatewayPatRuleResult).value

    return AwaitableGetVpcPublicGatewayPatRuleResult(
...
def get_vpc_public_gateway_pat_rule_output(pat_rule_id: Optional[pulumi.Input[builtins.str]] = None,
                                           zone: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                           opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetVpcPublicGatewayPatRuleResult]:
    """
    Gets information about a Public Gateway PAT rule. For further information, please see the
    [API documentation](https://www.scaleway.com/en/developers/api/public-gateway/#path-pat-rules-list-pat-rules).
