...
def get_object_bucket_policy(bucket: Optional[builtins.str] = None,
    ...
    :param builtins.str region: `region`) The region in which the Object Storage exists.
    """
    __args__ = dict()
...
def get_object_bucket_policy_output(bucket: Optional[pulumi.Input[builtins.str]] = None,
