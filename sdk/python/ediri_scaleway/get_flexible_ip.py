...
class GetFlexibleIpResult:
    ...
    def flexible_ip_id(self) -> Optional[builtins.str]:
...
def get_flexible_ip(flexible_ip_id: Optional[builtins.str] = None,
    ...
    with_ip = scaleway.get_flexible_ip(ip_address="1.2.3.4")
    with_id = scaleway.get_flexible_ip(flexible_ip_id="11111111-1111-1111-1111-111111111111")
    ```


    :param builtins.str flexible_ip_id: The IP ID.
           Only one of `ip_address` and `flexible_ip_id` should be specified.
    :param builtins.str ip_address: The IP address.
           Only one of `ip_address` and `flexible_ip_id` should be specified.
    :param builtins.str project_id: `project_id`) The ID of the Project the Flexible IP is associated with.
    """
    __args__ = dict()
...
def get_flexible_ip_output(flexible_ip_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
