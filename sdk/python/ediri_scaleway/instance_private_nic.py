...
class InstancePrivateNicArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] private_network_id: The ID of the private network attached to.
        :param pulumi.Input[builtins.str] server_id: The ID of the server associated with.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ip_ids: IPAM ip list, should be for internal use only
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ipam_ip_ids: IPAM IDs of a pre-reserved IP addresses to assign to the Instance in the requested private network.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: The tags associated with the private NIC.
        :param pulumi.Input[builtins.str] zone: `zone`) The zone in which the server must be created.
        """
...
class _InstancePrivateNicState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ip_ids: IPAM ip list, should be for internal use only
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ipam_ip_ids: IPAM IDs of a pre-reserved IP addresses to assign to the Instance in the requested private network.
        :param pulumi.Input[builtins.str] mac_address: The MAC address of the private NIC.
        :param pulumi.Input[Sequence[pulumi.Input['InstancePrivateNicPrivateIpArgs']]] private_ips: The list of private IPv4 and IPv6 addresses associated with the resource.
        :param pulumi.Input[builtins.str] private_network_id: The ID of the private network attached to.
        :param pulumi.Input[builtins.str] server_id: The ID of the server associated with.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: The tags associated with the private NIC.
...
class InstancePrivateNic(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        pn01 = scaleway.VpcPrivateNetwork("pn01", region="fr-par")
    ...
    def get(resource_name: str,
            ...
            server_id: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            zone: Optional[pulumi.Input[builtins.str]] = None) -> 'InstancePrivateNic':
        """
    ...
    @property
    @pulumi.getter(name="ipamIpIds")
    def ipam_ip_ids(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        IPAM IDs of a pre-reserved IP addresses to assign to the Instance in the requested private network.
        """
        return pulumi.get(self, "ipam_ip_ids")
