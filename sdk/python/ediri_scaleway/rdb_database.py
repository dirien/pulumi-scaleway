...
class RdbDatabaseArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: Name of the database (e.g. `my-new-database`).
...
class _RdbDatabaseState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] instance_id: UUID of the Database Instance.
               ...
               > **Important:** Updates to `instance_id` will recreate the database.
        :param pulumi.Input[builtins.bool] managed: Whether the database is managed or not.
        :param pulumi.Input[builtins.str] name: Name of the database (e.g. `my-new-database`).
        :param pulumi.Input[builtins.str] owner: The name of the owner of the database.
        :param pulumi.Input[builtins.str] region: `region`) The region in which the resource exists.
        :param pulumi.Input[builtins.str] size: Size of the database (in bytes).
        """
...
@pulumi.type_token("scaleway:index/rdbDatabase:RdbDatabase")
class RdbDatabase(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            owner: Optional[pulumi.Input[builtins.str]] = None,
            region: Optional[pulumi.Input[builtins.str]] = None,
            size: Optional[pulumi.Input[builtins.str]] = None) -> 'RdbDatabase':
        """
