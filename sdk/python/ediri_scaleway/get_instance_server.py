...
class GetInstanceServerResult:
    ...
    def admin_password_encryption_ssh_key_id(self) -> builtins.str:
    ...
    def replace_on_type_change(self) -> builtins.bool:
    ...
    def user_data(self) -> Mapping[str, builtins.str]:
        """
...
def get_instance_server(name: Optional[builtins.str] = None,
    ...
    :param builtins.str project_id: The ID of the project the instance server is associated with.
    :param builtins.str server_id: The server id. Only one of `name` and `server_id` should be specified.
...
def get_instance_server_output(name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
