...
class GetInstancePlacementGroupResult:
    ...
    def policy_respected(self) -> builtins.bool:
        """
...
def get_instance_placement_group(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: The placement group name. Only one of `name` and `placement_group_id` should be specified.
    :param builtins.str placement_group_id: The placement group id. Only one of `name` and `placement_group_id` should be specified.
    :param builtins.str project_id: `project_id`) The ID of the project the placement group is associated with.
    :param builtins.str zone: `zone`) The zone in which the placement group exists.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_instance_placement_group_output(name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                        placement_group_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
