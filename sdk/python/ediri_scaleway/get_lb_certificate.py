...
class GetLbCertificateResult:
    ...
    def custom_certificates(self) -> Sequence['outputs.GetLbCertificateCustomCertificateResult']:
    ...
    @property
    @pulumi.getter
    def letsencrypts(self) -> Sequence['outputs.GetLbCertificateLetsencryptResult']:
...
def get_lb_certificate(certificate_id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('scaleway:index/getLbCertificate:getLbCertificate', __args__, opts=opts, typ=GetLbCertificateResult).value
...
def get_lb_certificate_output(certificate_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
