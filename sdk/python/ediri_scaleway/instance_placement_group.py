...
class InstancePlacementGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] policy_mode: The [policy mode](https://www.scaleway.com/en/developers/api/instance/#path-placement-groups-create-a-placement-group) of the placement group. Possible values are: `optional` or `enforced`.
        :param pulumi.Input[builtins.str] policy_type: The [policy type](https://www.scaleway.com/en/developers/api/instance/#path-placement-groups-create-a-placement-grou) of the placement group. Possible values are: `low_latency` or `max_availability`.
        :param pulumi.Input[builtins.str] project_id: `project_id`) The ID of the project the placement group is associated with.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: A list of tags to apply to the placement group.
        :param pulumi.Input[builtins.str] zone: `zone`) The zone in which the placement group should be created.
        """
        if name is not None:
...
class _InstancePlacementGroupState:
    def __init__(__self__, *,
                 ...
                 policy_mode: Optional[pulumi.Input[builtins.str]] = None,
                 policy_respected: Optional[pulumi.Input[builtins.bool]] = None,
                 policy_type: Optional[pulumi.Input[builtins.str]] = None,
                 project_id: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 zone: Optional[pulumi.Input[builtins.str]] = None):
        ...
        :param pulumi.Input[builtins.str] name: The name of the placement group.
        :param pulumi.Input[builtins.str] organization_id: The organization ID the placement group is associated with.
        :param pulumi.Input[builtins.str] policy_mode: The [policy mode](https://www.scaleway.com/en/developers/api/instance/#path-placement-groups-create-a-placement-group) of the placement group. Possible values are: `optional` or `enforced`.
        :param pulumi.Input[builtins.bool] policy_respected: Is true when the policy is respected.
        :param pulumi.Input[builtins.str] policy_type: The [policy type](https://www.scaleway.com/en/developers/api/instance/#path-placement-groups-create-a-placement-grou) of the placement group. Possible values are: `low_latency` or `max_availability`.
        :param pulumi.Input[builtins.str] project_id: `project_id`) The ID of the project the placement group is associated with.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: A list of tags to apply to the placement group.
        :param pulumi.Input[builtins.str] zone: `zone`) The zone in which the placement group should be created.
    ...
    def policy_respected(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def policy_respected(self, value: Optional[pulumi.Input[builtins.bool]]):
...
@pulumi.type_token("scaleway:index/instancePlacementGroup:InstancePlacementGroup")
class InstancePlacementGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            project_id: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            zone: Optional[pulumi.Input[builtins.str]] = None) -> 'InstancePlacementGroup':
        """
    ...
    @property
    @pulumi.getter(name="policyMode")
    def policy_mode(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The [policy mode](https://www.scaleway.com/en/developers/api/instance/#path-placement-groups-create-a-placement-group) of the placement group. Possible values are: `optional` or `enforced`.
        """
        return pulumi.get(self, "policy_mode")
    ...
    @property
    @pulumi.getter(name="policyRespected")
    def policy_respected(self) -> pulumi.Output[builtins.bool]:
        """
        Is true when the policy is respected.
        """
        return pulumi.get(self, "policy_respected")
