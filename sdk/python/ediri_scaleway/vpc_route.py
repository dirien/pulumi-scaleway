...
class VpcRouteArgs:
    def __init__(__self__, *,
                 ...
                 nexthop_private_network_id: Optional[pulumi.Input[builtins.str]] = None,
                 nexthop_resource_id: Optional[pulumi.Input[builtins.str]] = None,
                 region: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a VpcRoute resource.
        :param pulumi.Input[builtins.str] vpc_id: The VPC ID the route belongs to.
        :param pulumi.Input[builtins.str] description: The route description.
        :param pulumi.Input[builtins.str] destination: The destination of the route.
        :param pulumi.Input[builtins.str] nexthop_private_network_id: The ID of the nexthop private network.
        :param pulumi.Input[builtins.str] nexthop_resource_id: The ID of the nexthop resource.
        :param pulumi.Input[builtins.str] region: `region`) The region of the route.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: The tags to associate with the route.
        """
    ...
    def nexthop_private_network_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def nexthop_private_network_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "nexthop_private_network_id", value)

    @property
    @pulumi.getter(name="nexthopResourceId")
    def nexthop_resource_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def nexthop_resource_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _VpcRouteState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] created_at: The date and time of the creation of the route (RFC 3339 format).
        :param pulumi.Input[builtins.str] description: The route description.
        :param pulumi.Input[builtins.str] destination: The destination of the route.
        :param pulumi.Input[builtins.str] nexthop_private_network_id: The ID of the nexthop private network.
        :param pulumi.Input[builtins.str] nexthop_resource_id: The ID of the nexthop resource.
        :param pulumi.Input[builtins.str] region: `region`) The region of the route.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: The tags to associate with the route.
        :param pulumi.Input[builtins.str] updated_at: The date and time of the creation of the route (RFC 3339 format).
        :param pulumi.Input[builtins.str] vpc_id: The VPC ID the route belongs to.
        """
...
class VpcRoute(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="nexthopPrivateNetworkId")
    def nexthop_private_network_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the nexthop private network.
        """
        return pulumi.get(self, "nexthop_private_network_id")
    ...
    @property
    @pulumi.getter(name="nexthopResourceId")
    def nexthop_resource_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the nexthop resource.
        """
        return pulumi.get(self, "nexthop_resource_id")
