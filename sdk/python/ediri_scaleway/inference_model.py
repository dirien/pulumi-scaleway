...
__all__ = ['InferenceModelArgs', 'InferenceModel']

@pulumi.input_type
class InferenceModelArgs:
...
@pulumi.input_type
class _InferenceModelState:
    def __init__(__self__, *,
                 created_at: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 has_eula: Optional[pulumi.Input[builtins.bool]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 nodes_supports: Optional[pulumi.Input[Sequence[pulumi.Input['InferenceModelNodesSupportArgs']]]] = None,
        ...
        :param pulumi.Input[builtins.str] name: The name of the model. This must be unique within the project.
        :param pulumi.Input[Sequence[pulumi.Input['InferenceModelNodesSupportArgs']]] nodes_supports: List of supported node types and their quantization options. Each entry contains:
    ...
    def nodes_supports(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['InferenceModelNodesSupportArgs']]]]:
        """
    ...
    def nodes_supports(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['InferenceModelNodesSupportArgs']]]]):
...
@pulumi.type_token("scaleway:index/inferenceModel:InferenceModel")
class InferenceModel(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test = scaleway.InferenceModel("test",
        ...
        my_model = scaleway.InferenceModel("myModel",
            url="https://huggingface.co/agentica-org/DeepCoder-14B-Preview",
            secret="my-secret-token")
        my_deployment = scaleway.InferenceDeployment("myDeployment",
            node_type="H100",
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param InferenceModelArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(InferenceModelArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = InferenceModelArgs.__new__(InferenceModelArgs)
        ...
        super(InferenceModel, __self__).__init__(
            'scaleway:index/inferenceModel:InferenceModel',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            has_eula: Optional[pulumi.Input[builtins.bool]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            nodes_supports: Optional[pulumi.Input[Sequence[pulumi.Input[Union['InferenceModelNodesSupportArgs', 'InferenceModelNodesSupportArgsDict']]]]] = None,
            parameter_size_bits: Optional[pulumi.Input[builtins.int]] = None,
            project_id: Optional[pulumi.Input[builtins.str]] = None,
            region: Optional[pulumi.Input[builtins.str]] = None,
            secret: Optional[pulumi.Input[builtins.str]] = None,
            ...
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            updated_at: Optional[pulumi.Input[builtins.str]] = None,
            url: Optional[pulumi.Input[builtins.str]] = None) -> 'InferenceModel':
        """
        ...
        :param pulumi.Input[builtins.bool] has_eula: Whether the model requires end-user license agreement acceptance before use.
        :param pulumi.Input[builtins.str] name: The name of the model. This must be unique within the project.
        :param pulumi.Input[Sequence[pulumi.Input[Union['InferenceModelNodesSupportArgs', 'InferenceModelNodesSupportArgsDict']]]] nodes_supports: List of supported node types and their quantization options. Each entry contains:
        :param pulumi.Input[builtins.int] parameter_size_bits: Size, in bits, of the model parameters.
        :param pulumi.Input[builtins.str] project_id: `project_id`) The ID of the project the deployment is associated with.
        :param pulumi.Input[builtins.str] region: `region`) The region in which the deployment is created.
        :param pulumi.Input[builtins.str] secret: Authentication token used to pull the model from a private or gated URL (e.g., a Hugging Face access token with read permission).
        ...
        __props__ = _InferenceModelState.__new__(_InferenceModelState)
        ...
        __props__.__dict__["url"] = url
        return InferenceModel(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="nodesSupports")
    def nodes_supports(self) -> pulumi.Output[Sequence['outputs.InferenceModelNodesSupport']]:
        """
        List of supported node types and their quantization options. Each entry contains:
        """
        return pulumi.get(self, "nodes_supports")
