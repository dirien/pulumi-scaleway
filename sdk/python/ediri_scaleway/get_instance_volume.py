...
class GetInstanceVolumeResult:
    ...
    def from_snapshot_id(self) -> builtins.str:
    ...
    def migrate_to_sbs(self) -> builtins.bool:
...
def get_instance_volume(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: The volume name.
           Only one of `name` and `volume_id` should be specified.
    :param builtins.str project_id: The ID of the project the volume is associated with.
    :param builtins.str volume_id: The volume id.
           Only one of `name` and `volume_id` should be specified.
    :param builtins.str zone: `zone`) The zone in which the volume exists.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_instance_volume_output(name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
