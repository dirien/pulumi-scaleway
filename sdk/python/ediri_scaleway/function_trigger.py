...
class FunctionTriggerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] function_id: The unique identifier of the function to create a trigger for.
        :param pulumi.Input[builtins.str] description: The description of the trigger.
        :param pulumi.Input[builtins.str] name: The unique name of the trigger. If not provided, a random name is generated.
...
@pulumi.type_token("scaleway:index/functionTrigger:FunctionTrigger")
