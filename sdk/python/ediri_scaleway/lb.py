...
class LbArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ip_ids: The List of IP IDs to attach to the Load Balancer.
               ...
               > **Important:** Make sure to use a `LbIp` resource to create the IPs.
...
class _LbState:
    def __init__(__self__, *,
                 ...
                 private_ips: Optional[pulumi.Input[Sequence[pulumi.Input['LbPrivateIpArgs']]]] = None,
                 private_networks: Optional[pulumi.Input[Sequence[pulumi.Input['LbPrivateNetworkArgs']]]] = None,
                 project_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['LbPrivateIpArgs']]] private_ips: The list of private IPv4 and IPv6 addresses associated with the resource.
        :param pulumi.Input[Sequence[pulumi.Input['LbPrivateNetworkArgs']]] private_networks: List of private network to connect with your load balancer.
        :param pulumi.Input[builtins.str] project_id: `project_id`) The ID of the Project the Load Balancer is associated with.
    ...
    def private_ips(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['LbPrivateIpArgs']]]]:
        """
    ...
    @private_ips.setter
    def private_ips(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['LbPrivateIpArgs']]]]):
...
@pulumi.type_token("scaleway:index/lb:Lb")
class Lb(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 ip_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 private_networks: Optional[pulumi.Input[Sequence[pulumi.Input[Union['LbPrivateNetworkArgs', 'LbPrivateNetworkArgsDict']]]]] = None,
                 project_id: Optional[pulumi.Input[builtins.str]] = None,
                 release_ip: Optional[pulumi.Input[builtins.bool]] = None,
                 ssl_compatibility_level: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        v4 = scaleway.LbIp("v4")
        v6 = scaleway.LbIp("v6", is_ipv6=True)
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ip_ids: The List of IP IDs to attach to the Load Balancer.
               ...
               > **Important:** Make sure to use a `LbIp` resource to create the IPs.
        :param pulumi.Input[builtins.str] name: The name of the Load Balancer.
        :param pulumi.Input[Sequence[pulumi.Input[Union['LbPrivateNetworkArgs', 'LbPrivateNetworkArgsDict']]]] private_networks: List of private network to connect with your load balancer.
        :param pulumi.Input[builtins.str] project_id: `project_id`) The ID of the Project the Load Balancer is associated with.
        :param pulumi.Input[builtins.bool] release_ip: The `release_ip` allow the release of the IP address associated with the Load Balancer.
        :param pulumi.Input[builtins.str] ssl_compatibility_level: Enforces minimal SSL version (in SSL/TLS offloading context). Please check [possible values](https://www.scaleway.com/en/developers/api/load-balancer/zoned-api/#path-load-balancer-create-a-load-balancer).
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: The tags associated with the Load Balancer.
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            organization_id: Optional[pulumi.Input[builtins.str]] = None,
            private_ips: Optional[pulumi.Input[Sequence[pulumi.Input[Union['LbPrivateIpArgs', 'LbPrivateIpArgsDict']]]]] = None,
            private_networks: Optional[pulumi.Input[Sequence[pulumi.Input[Union['LbPrivateNetworkArgs', 'LbPrivateNetworkArgsDict']]]]] = None,
            project_id: Optional[pulumi.Input[builtins.str]] = None,
            region: Optional[pulumi.Input[builtins.str]] = None,
            release_ip: Optional[pulumi.Input[builtins.bool]] = None,
            ...
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None,
            zone: Optional[pulumi.Input[builtins.str]] = None) -> 'Lb':
        """
        ...
        :param pulumi.Input[builtins.str] name: The name of the Load Balancer.
        :param pulumi.Input[builtins.str] organization_id: The ID of the Organization ID the Load Balancer is associated with.
        :param pulumi.Input[Sequence[pulumi.Input[Union['LbPrivateIpArgs', 'LbPrivateIpArgsDict']]]] private_ips: The list of private IPv4 and IPv6 addresses associated with the resource.
        :param pulumi.Input[Sequence[pulumi.Input[Union['LbPrivateNetworkArgs', 'LbPrivateNetworkArgsDict']]]] private_networks: List of private network to connect with your load balancer.
        :param pulumi.Input[builtins.str] project_id: `project_id`) The ID of the Project the Load Balancer is associated with.
        :param pulumi.Input[builtins.str] region: The region of the resource
        :param pulumi.Input[builtins.bool] release_ip: The `release_ip` allow the release of the IP address associated with the Load Balancer.
    ...
    @property
    @pulumi.getter(name="privateIps")
    def private_ips(self) -> pulumi.Output[Sequence['outputs.LbPrivateIp']]:
        """
        The list of private IPv4 and IPv6 addresses associated with the resource.
        """
        return pulumi.get(self, "private_ips")
