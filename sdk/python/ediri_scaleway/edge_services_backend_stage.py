...
class EdgeServicesBackendStage(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        main_object_bucket = scaleway.ObjectBucket("mainObjectBucket", tags={
            "foo": "bar",
        })
        main_edge_services_pipeline = scaleway.EdgeServicesPipeline("mainEdgeServicesPipeline")
        ...
        main_lb = scaleway.Lb("mainLb",
            ...
            zone="fr-par-1",
            type="LB-S")
        main_lb_frontend = scaleway.LbFrontend("mainLbFrontend",
            lb_id=main_lb.id,
