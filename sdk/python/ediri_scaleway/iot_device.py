...
class IotDeviceArgs:
    def __init__(__self__, *,
                 hub_id: pulumi.Input[builtins.str],
                 allow_insecure: Optional[pulumi.Input[builtins.bool]] = None,
                 allow_multiple_connections: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] hub_id: The ID of the hub on which this device will be created.
        :param pulumi.Input[builtins.bool] allow_insecure: Allow plain and server-authenticated TLS connections in addition to mutually-authenticated ones.
               
               > **Important:** Updates to `allow_insecure` can disconnect eventually connected devices.
        :param pulumi.Input[builtins.bool] allow_multiple_connections: Allow more than one simultaneous connection using the same device credentials.
        ...
        :param pulumi.Input[builtins.str] description: The description of the IoT device (e.g. `living room`).
        ...
        :param pulumi.Input[builtins.str] name: The name of the IoT device you want to create (e.g. `my-device`).
    ...
    def hub_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @hub_id.setter
    def hub_id(self, value: pulumi.Input[builtins.str]):
    ...
    def allow_multiple_connections(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def allow_multiple_connections(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _IotDeviceState:
    def __init__(__self__, *,
                 ...
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 hub_id: Optional[pulumi.Input[builtins.str]] = None,
                 is_connected: Optional[pulumi.Input[builtins.bool]] = None,
                 last_activity_at: Optional[pulumi.Input[builtins.str]] = None,
                 message_filters: Optional[pulumi.Input['IotDeviceMessageFiltersArgs']] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 region: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.bool] allow_multiple_connections: Allow more than one simultaneous connection using the same device credentials.
               ...
               > **Important:** Updates to `allow_multiple_connections` can disconnect eventually connected devices.
        :param pulumi.Input['IotDeviceCertificateArgs'] certificate: The certificate bundle of the device.
        :param pulumi.Input[builtins.str] created_at: The date and time the device was created.
        :param pulumi.Input[builtins.str] description: The description of the IoT device (e.g. `living room`).
        :param pulumi.Input[builtins.str] hub_id: The ID of the hub on which this device will be created.
        :param pulumi.Input[builtins.bool] is_connected: The current connection status of the device.
        :param pulumi.Input[builtins.str] last_activity_at: The last MQTT activity of the device.
        :param pulumi.Input['IotDeviceMessageFiltersArgs'] message_filters: Rules that define which messages are authorized or denied based on their topic.
        :param pulumi.Input[builtins.str] name: The name of the IoT device you want to create (e.g. `my-device`).
               
               > **Important:** Updates to `name` will destroy and recreate a new resource.
        :param pulumi.Input[builtins.str] region: The region you want to attach the resource to
        :param pulumi.Input[builtins.str] status: The current status of the device.
        :param pulumi.Input[builtins.str] updated_at: The date and time the device resource was updated.
        """
        if allow_insecure is not None:
            pulumi.set(__self__, "allow_insecure", allow_insecure)
        if allow_multiple_connections is not None:
    ...
    @property
    @pulumi.getter(name="hubId")
    def hub_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the hub on which this device will be created.
        """
        return pulumi.get(self, "hub_id")
    ...
    @hub_id.setter
    def hub_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "hub_id", value)

    @property
    @pulumi.getter(name="isConnected")
    def is_connected(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @is_connected.setter
    def is_connected(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_connected", value)

    @property
    @pulumi.getter(name="lastActivityAt")
    def last_activity_at(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def last_activity_at(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("scaleway:index/iotDevice:IotDevice")
class IotDevice(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            region: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            updated_at: Optional[pulumi.Input[builtins.str]] = None) -> 'IotDevice':
        """
    ...
    @property
    @pulumi.getter(name="allowMultipleConnections")
    def allow_multiple_connections(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Allow more than one simultaneous connection using the same device credentials.
    ...
    @property
    @pulumi.getter(name="hubId")
    def hub_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the hub on which this device will be created.
        """
        return pulumi.get(self, "hub_id")
    ...
    @property
    @pulumi.getter(name="isConnected")
    def is_connected(self) -> pulumi.Output[builtins.bool]:
        """
        The current connection status of the device.
        """
        return pulumi.get(self, "is_connected")
    ...
    @property
    @pulumi.getter(name="lastActivityAt")
    def last_activity_at(self) -> pulumi.Output[builtins.str]:
        """
        The last MQTT activity of the device.
        """
        return pulumi.get(self, "last_activity_at")
