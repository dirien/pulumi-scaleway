...
class GetLbIpsResult:
    ...
    def ip_cidr_range(self) -> Optional[builtins.str]:
        return pulumi.get(self, "ip_cidr_range")

    @property
    @pulumi.getter(name="ipType")
    def ip_type(self) -> Optional[builtins.str]:
...
def get_lb_ips(ip_cidr_range: Optional[builtins.str] = None,
               ip_type: Optional[builtins.str] = None,
    ...
    :param builtins.str ip_cidr_range: The IP CIDR range to filter for. IPs within a matching CIDR block are listed.
    :param builtins.str ip_type: The IP type used as a filter.
...
def get_lb_ips_output(ip_cidr_range: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                      ip_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
