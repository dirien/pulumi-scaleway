...
class GetVpcPublicGatewayDhcpReservationResult:
    ...
    def reservation_id(self) -> Optional[builtins.str]:
    ...
    def wait_for_dhcp(self) -> Optional[builtins.bool]:
...
def get_vpc_public_gateway_dhcp_reservation(gateway_network_id: Optional[builtins.str] = None,
    ...
    """
    > **Important:**  The data source `VpcPublicGatewayDhcpReservation` has been deprecated and will no longer be supported.
