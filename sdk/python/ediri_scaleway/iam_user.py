...
class IamUserArgs:
    def __init__(__self__, *,
                 ...
                 send_password_email: Optional[pulumi.Input[builtins.bool]] = None,
                 send_welcome_email: Optional[pulumi.Input[builtins.bool]] = None,
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a IamUser resource.
        :param pulumi.Input[builtins.str] email: The email of the IAM user. For Guest users, this argument is not editable.
        :param pulumi.Input[builtins.str] username: The username of the IAM user.
        ...
        :param pulumi.Input[builtins.str] locale: The user's locale (e.g., en_US).
        :param pulumi.Input[builtins.str] organization_id: `organization_id`) The ID of the organization the user is associated with.
        :param pulumi.Input[builtins.str] password: The password for first access.
        :param pulumi.Input[builtins.str] phone_number: The user's phone number.
        :param pulumi.Input[builtins.bool] send_password_email: Whether or not to send an email containing the password for first access.
        :param pulumi.Input[builtins.bool] send_welcome_email: Whether or not to send a welcome email that includes onboarding information.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: The tags associated with the user.
        """
    ...
    def send_password_email(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def send_password_email(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "send_password_email", value)

    @property
    @pulumi.getter(name="sendWelcomeEmail")
    def send_welcome_email(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def send_welcome_email(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _IamUserState:
    def __init__(__self__, *,
                 account_root_user_id: Optional[pulumi.Input[builtins.str]] = None,
                 created_at: Optional[pulumi.Input[builtins.str]] = None,
                 deletable: Optional[pulumi.Input[builtins.bool]] = None,
                 email: Optional[pulumi.Input[builtins.str]] = None,
                 first_name: Optional[pulumi.Input[builtins.str]] = None,
                 last_login_at: Optional[pulumi.Input[builtins.str]] = None,
                 last_name: Optional[pulumi.Input[builtins.str]] = None,
                 locale: Optional[pulumi.Input[builtins.str]] = None,
                 locked: Optional[pulumi.Input[builtins.bool]] = None,
                 mfa: Optional[pulumi.Input[builtins.bool]] = None,
                 organization_id: Optional[pulumi.Input[builtins.str]] = None,
                 password: Optional[pulumi.Input[builtins.str]] = None,
                 phone_number: Optional[pulumi.Input[builtins.str]] = None,
                 send_password_email: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] account_root_user_id: The ID of the account root user associated with the user.
        :param pulumi.Input[builtins.str] created_at: The date and time of the creation of the IAM user.
        :param pulumi.Input[builtins.bool] deletable: Whether the IAM user is deletable.
        :param pulumi.Input[builtins.str] email: The email of the IAM user. For Guest users, this argument is not editable.
        :param pulumi.Input[builtins.str] first_name: The user's first name.
        :param pulumi.Input[builtins.str] last_login_at: The date of the last login.
        :param pulumi.Input[builtins.str] last_name: The user's last name.
        :param pulumi.Input[builtins.str] locale: The user's locale (e.g., en_US).
        :param pulumi.Input[builtins.bool] locked: Whether the user is locked.
        :param pulumi.Input[builtins.bool] mfa: Whether the MFA is enabled.
        :param pulumi.Input[builtins.str] organization_id: `organization_id`) The ID of the organization the user is associated with.
        :param pulumi.Input[builtins.str] password: The password for first access.
        :param pulumi.Input[builtins.str] phone_number: The user's phone number.
        :param pulumi.Input[builtins.bool] send_password_email: Whether or not to send an email containing the password for first access.
        :param pulumi.Input[builtins.bool] send_welcome_email: Whether or not to send a welcome email that includes onboarding information.
        :param pulumi.Input[builtins.str] status: The status of user invitation. Check the possible values in the [API doc](https://www.scaleway.com/en/developers/api/iam/#path-users-get-a-given-user).
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: The tags associated with the user.
        :param pulumi.Input[builtins.str] type: The type of user. Check the possible values in the [API doc](https://www.scaleway.com/en/developers/api/iam/#path-users-get-a-given-user).
        :param pulumi.Input[builtins.str] updated_at: The date and time of the last update of the IAM user.
        :param pulumi.Input[builtins.str] username: The username of the IAM user.
        """
    ...
    def account_root_user_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def account_root_user_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def last_login_at(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def last_login_at(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter
    def mfa(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @mfa.setter
    def mfa(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class IamUser(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        for range in [{"value": i} for i in range(0, len(users))]:
            users_iam_user.append(scaleway.IamUser(f"usersIamUser-{range['value']}",
    ...
    def get(resource_name: str,
            ...
            type: Optional[pulumi.Input[builtins.str]] = None,
            updated_at: Optional[pulumi.Input[builtins.str]] = None,
            username: Optional[pulumi.Input[builtins.str]] = None) -> 'IamUser':
        """
    ...
    @property
    @pulumi.getter(name="accountRootUserId")
    def account_root_user_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the account root user associated with the user.
        """
        return pulumi.get(self, "account_root_user_id")
    ...
    @property
    @pulumi.getter(name="lastLoginAt")
    def last_login_at(self) -> pulumi.Output[builtins.str]:
        """
        The date of the last login.
        """
        return pulumi.get(self, "last_login_at")
    ...
    @property
    @pulumi.getter
    def mfa(self) -> pulumi.Output[builtins.bool]:
        """
        Whether the MFA is enabled.
        """
        return pulumi.get(self, "mfa")
    ...
    @property
    @pulumi.getter(name="sendPasswordEmail")
    def send_password_email(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether or not to send an email containing the password for first access.
        """
        return pulumi.get(self, "send_password_email")
    ...
    @property
    @pulumi.getter(name="sendWelcomeEmail")
    def send_welcome_email(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether or not to send a welcome email that includes onboarding information.
        """
        return pulumi.get(self, "send_welcome_email")
