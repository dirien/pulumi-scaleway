...
def get_lb_backends(lb_id: Optional[builtins.str] = None,
    ...
    :param builtins.str zone: `zone`) The zone in which backends exist.
    """
    __args__ = dict()
    __args__['lbId'] = lb_id
    __args__['name'] = name
...
def get_lb_backends_output(lb_id: Optional[pulumi.Input[builtins.str]] = None,
