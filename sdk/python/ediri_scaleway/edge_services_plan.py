...
class EdgeServicesPlanArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: The name of the plan.
        :param pulumi.Input[builtins.str] project_id: `project_id`) The ID of the project the plan is associated with.
        """
        if name is not None:
...
class EdgeServicesPlan(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        main = scaleway.EdgeServicesPlan("main")
        ```
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            project_id: Optional[pulumi.Input[builtins.str]] = None) -> 'EdgeServicesPlan':
        """
