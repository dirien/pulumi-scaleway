...
def get_lb_acls(frontend_id: Optional[builtins.str] = None,
    ...
    :param builtins.str zone: `zone`) The zone in which the ACLs exist.
    """
    __args__ = dict()
...
def get_lb_acls_output(frontend_id: Optional[pulumi.Input[builtins.str]] = None,
