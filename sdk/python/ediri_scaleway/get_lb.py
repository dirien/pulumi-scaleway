...
class GetLbResult:
    ...
    def private_ips(self) -> Sequence['outputs.GetLbPrivateIpResult']:
...
def get_lb(lb_id: Optional[builtins.str] = None,
...
def get_lb_output(lb_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('scaleway:index/getLb:getLb', __args__, opts=opts, typ=GetLbResult)
