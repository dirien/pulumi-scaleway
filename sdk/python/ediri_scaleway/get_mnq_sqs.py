...
def get_mnq_sqs(project_id: Optional[builtins.str] = None,
    ...
    :param builtins.str project_id: `project_id`) The ID of the Project in which SQS is enabled.
    :param builtins.str region: `region`). The region in which SQS is enabled.
    """
    __args__ = dict()
...
def get_mnq_sqs_output(project_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
