...
class GetK8sVersionResult:
    ...
    def available_cnis(self) -> Sequence[builtins.str]:
        """
    ...
    def available_container_runtimes(self) -> Sequence[builtins.str]:
        """
    ...
    def available_feature_gates(self) -> Sequence[builtins.str]:
        """
...
def get_k8s_version(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: The name of the Kubernetes version.
    :param builtins.str region: `region`) The region in which the version exists.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_k8s_version_output(name: Optional[pulumi.Input[builtins.str]] = None,
