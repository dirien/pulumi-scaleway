...
class AwaitableGetLbIpResult(GetLbIpResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetLbIpResult(
            id=self.id,
...
def get_lb_ip(ip_address: Optional[builtins.str] = None,
              ip_id: Optional[builtins.str] = None,
              project_id: Optional[builtins.str] = None,
              zone: Optional[builtins.str] = None,
              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetLbIpResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('scaleway:index/getLbIp:getLbIp', __args__, opts=opts, typ=GetLbIpResult).value

    return AwaitableGetLbIpResult(
...
def get_lb_ip_output(ip_address: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                     ip_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                     project_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                     zone: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                     opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetLbIpResult]:
    """
    Gets information about a Load Balancer IP address.
    ...
    __ret__ = pulumi.runtime.invoke_output('scaleway:index/getLbIp:getLbIp', __args__, opts=opts, typ=GetLbIpResult)
    return __ret__.apply(lambda __response__: GetLbIpResult(
