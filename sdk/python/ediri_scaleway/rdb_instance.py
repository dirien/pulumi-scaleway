...
class RdbInstanceArgs:
    def __init__(__self__, *,
                 ...
                 private_ips: Optional[pulumi.Input[Sequence[pulumi.Input['RdbInstancePrivateIpArgs']]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['RdbInstancePrivateIpArgs']]] private_ips: The private IPv4 address associated with the resource.
    ...
    def private_ips(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['RdbInstancePrivateIpArgs']]]]:
        """
    ...
    @private_ips.setter
    def private_ips(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['RdbInstancePrivateIpArgs']]]]):
...
@pulumi.type_token("scaleway:index/rdbInstance:RdbInstance")
class RdbInstance(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 node_type: Optional[pulumi.Input[builtins.str]] = None,
                 password: Optional[pulumi.Input[builtins.str]] = None,
                 private_ips: Optional[pulumi.Input[Sequence[pulumi.Input[Union['RdbInstancePrivateIpArgs', 'RdbInstancePrivateIpArgsDict']]]]] = None,
        ...
        :param pulumi.Input[builtins.str] node_type: The type of Database Instance you want to create (e.g. `db-dev-s`).
               ...
               > **Important** Once your Database Instance reaches `disk_full` status, if you are using `lssd` storage, you should upgrade the `node_type`, and if you are using `bssd` storage, you should increase the volume size before making any other changes to your Database Instance.
        :param pulumi.Input[builtins.str] password: Password for the first user of the Database Instance.
        :param pulumi.Input[Sequence[pulumi.Input[Union['RdbInstancePrivateIpArgs', 'RdbInstancePrivateIpArgsDict']]]] private_ips: The private IPv4 address associated with the resource.
    ...
    def get(resource_name: str,
            ...
            user_name: Optional[pulumi.Input[builtins.str]] = None,
            volume_size_in_gb: Optional[pulumi.Input[builtins.int]] = None,
            volume_type: Optional[pulumi.Input[builtins.str]] = None) -> 'RdbInstance':
        """
    ...
    @property
    @pulumi.getter(name="privateIps")
    def private_ips(self) -> pulumi.Output[Sequence['outputs.RdbInstancePrivateIp']]:
        """
        The private IPv4 address associated with the resource.
        """
        return pulumi.get(self, "private_ips")
