...
class InstanceVolumeArgs:
    def __init__(__self__, *,
                 ...
                 from_snapshot_id: Optional[pulumi.Input[builtins.str]] = None,
                 migrate_to_sbs: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] type: The type of the volume. The possible values are: `l_ssd` (Local SSD), `scratch` (Local Scratch SSD).
               
               > **Important:** Volumes with type `b_ssd` (Block SSD) are deprecated and cannot be managed using the `InstanceVolume` resource anymore. Please use the `BlockVolume` resource instead.
        ...
        :param pulumi.Input[builtins.str] from_snapshot_id: If set, the new volume will be created from this snapshot. Only one of `size_in_gb` and `from_snapshot_id` should be specified.
        :param pulumi.Input[builtins.bool] migrate_to_sbs: If true, consider that this volume may have been migrated and no longer exists.
        :param pulumi.Input[builtins.str] name: The name of the volume. If not provided it will be randomly generated.
        :param pulumi.Input[builtins.str] project_id: `project_id`) The ID of the project the volume is associated with.
        :param pulumi.Input[builtins.int] size_in_gb: The size of the volume. Only one of `size_in_gb` and `from_snapshot_id` should be specified.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: A list of tags to apply to the volume.
        :param pulumi.Input[builtins.str] zone: `zone`) The zone in which the volume should be created.
        """
    ...
    def from_snapshot_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def from_snapshot_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "from_snapshot_id", value)

    @property
    @pulumi.getter(name="migrateToSbs")
    def migrate_to_sbs(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def migrate_to_sbs(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _InstanceVolumeState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] migrate_to_sbs: If true, consider that this volume may have been migrated and no longer exists.
        :param pulumi.Input[builtins.str] name: The name of the volume. If not provided it will be randomly generated.
        :param pulumi.Input[builtins.str] organization_id: The organization ID the volume is associated with.
        :param pulumi.Input[builtins.str] project_id: `project_id`) The ID of the project the volume is associated with.
...
@pulumi.type_token("scaleway:index/instanceVolume:InstanceVolume")
class InstanceVolume(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None,
            zone: Optional[pulumi.Input[builtins.str]] = None) -> 'InstanceVolume':
        """
    ...
    @property
    @pulumi.getter(name="fromSnapshotId")
    def from_snapshot_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        If set, the new volume will be created from this snapshot. Only one of `size_in_gb` and `from_snapshot_id` should be specified.
        """
        return pulumi.get(self, "from_snapshot_id")
    ...
    @property
    @pulumi.getter(name="migrateToSbs")
    def migrate_to_sbs(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If true, consider that this volume may have been migrated and no longer exists.
        """
        return pulumi.get(self, "migrate_to_sbs")
