...
class InstanceImageArgs:
    def __init__(__self__, *,
                 root_volume_id: pulumi.Input[builtins.str],
                 additional_volume_ids: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] root_volume_id: The ID of the snapshot of the volume to be used as root in the image.
        :param pulumi.Input[builtins.str] additional_volume_ids: List of IDs of the snapshots of the additional volumes to be attached to the image.
               
               > **Important:** For now it is only possible to have 1 additional_volume.
        :param pulumi.Input[builtins.str] architecture: The architecture the image is compatible with. Possible values are: `x86_64` or `arm`.
        :param pulumi.Input[builtins.str] name: The name of the image. If not provided it will be randomly generated.
        :param pulumi.Input[builtins.str] project_id: The ID of the project the image is associated with.
        :param pulumi.Input[builtins.bool] public: Set to `true` if the image is public.
    ...
    def root_volume_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def root_volume_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "root_volume_id", value)

    @property
    @pulumi.getter(name="additionalVolumeIds")
    def additional_volume_ids(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def additional_volume_ids(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _InstanceImageState:
    def __init__(__self__, *,
                 ...
                 from_server_id: Optional[pulumi.Input[builtins.str]] = None,
                 modification_date: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 organization_id: Optional[pulumi.Input[builtins.str]] = None,
                 project_id: Optional[pulumi.Input[builtins.str]] = None,
                 public: Optional[pulumi.Input[builtins.bool]] = None,
                 root_volume_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] from_server_id: ID of the server the image is based on (in case it is a backup).
        :param pulumi.Input[builtins.str] modification_date: Date of volume latest update.
        :param pulumi.Input[builtins.str] name: The name of the image. If not provided it will be randomly generated.
        :param pulumi.Input[builtins.str] organization_id: The organization ID the image is associated with.
        :param pulumi.Input[builtins.str] project_id: The ID of the project the image is associated with.
        :param pulumi.Input[builtins.bool] public: Set to `true` if the image is public.
        :param pulumi.Input[builtins.str] root_volume_id: The ID of the snapshot of the volume to be used as root in the image.
    ...
    def from_server_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def from_server_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter(name="rootVolumeId")
    def root_volume_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the snapshot of the volume to be used as root in the image.
        """
        return pulumi.get(self, "root_volume_id")
    ...
    @root_volume_id.setter
    def root_volume_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "root_volume_id", value)
...
@pulumi.type_token("scaleway:index/instanceImage:InstanceImage")
class InstanceImage(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            state: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            zone: Optional[pulumi.Input[builtins.str]] = None) -> 'InstanceImage':
        """
    ...
    @property
    @pulumi.getter(name="additionalVolumeIds")
    def additional_volume_ids(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        List of IDs of the snapshots of the additional volumes to be attached to the image.
    ...
    @property
    @pulumi.getter(name="fromServerId")
    def from_server_id(self) -> pulumi.Output[builtins.str]:
        """
        ID of the server the image is based on (in case it is a backup).
        """
        return pulumi.get(self, "from_server_id")
    ...
    @property
    @pulumi.getter(name="modificationDate")
    def modification_date(self) -> pulumi.Output[builtins.str]:
        """
        Date of volume latest update.
        """
        return pulumi.get(self, "modification_date")
    ...
    @property
    @pulumi.getter(name="rootVolumeId")
    def root_volume_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the snapshot of the volume to be used as root in the image.
        """
        return pulumi.get(self, "root_volume_id")
