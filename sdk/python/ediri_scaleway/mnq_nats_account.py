...
class MnqNatsAccountArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: The unique name of the NATS account.
        :param pulumi.Input[builtins.str] project_id: `project_id`) The ID of the Project the
...
class _MnqNatsAccountState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] endpoint: The endpoint of the NATS service for this account.
        :param pulumi.Input[builtins.str] name: The unique name of the NATS account.
        :param pulumi.Input[builtins.str] project_id: `project_id`) The ID of the Project the
               account is associated with.
        :param pulumi.Input[builtins.str] region: `region`). The region
...
@pulumi.type_token("scaleway:index/mnqNatsAccount:MnqNatsAccount")
class MnqNatsAccount(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            project_id: Optional[pulumi.Input[builtins.str]] = None,
            region: Optional[pulumi.Input[builtins.str]] = None) -> 'MnqNatsAccount':
        """
