...
class GetIotDeviceResult:
    ...
    def allow_multiple_connections(self) -> builtins.bool:
...
def get_iot_device(device_id: Optional[builtins.str] = None,
    ...
    :param builtins.str device_id: The device ID.
...
def get_iot_device_output(device_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                          hub_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
