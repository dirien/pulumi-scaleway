...
class EdgeServicesWafStageArgs:
    def __init__(__self__, *,
                 paranoia_level: pulumi.Input[builtins.int],
        ...
        :param pulumi.Input[builtins.int] paranoia_level: The sensitivity level (`1`,`2`,`3`,`4`) to use when classifying requests as malicious. With a high level, requests are more likely to be classed as malicious, and false positives are expected. With a lower level, requests are more likely to be classed as benign.
        :param pulumi.Input[builtins.str] pipeline_id: The ID of the pipeline.
        :param pulumi.Input[builtins.str] backend_stage_id: The ID of the backend stage to forward requests to after the WAF stage.
        :param pulumi.Input[builtins.str] mode: The mode defining WAF behavior (`disable`/`log_only`/`enable`).
        :param pulumi.Input[builtins.str] project_id: `project_id`) The ID of the project the WAF stage is associated with.
        """
    ...
    def paranoia_level(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def paranoia_level(self, value: pulumi.Input[builtins.int]):
...
class _EdgeServicesWafStageState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] backend_stage_id: The ID of the backend stage to forward requests to after the WAF stage.
        :param pulumi.Input[builtins.str] created_at: The date and time of the creation of the WAF stage.
        :param pulumi.Input[builtins.str] mode: The mode defining WAF behavior (`disable`/`log_only`/`enable`).
        :param pulumi.Input[builtins.int] paranoia_level: The sensitivity level (`1`,`2`,`3`,`4`) to use when classifying requests as malicious. With a high level, requests are more likely to be classed as malicious, and false positives are expected. With a lower level, requests are more likely to be classed as benign.
        :param pulumi.Input[builtins.str] pipeline_id: The ID of the pipeline.
        :param pulumi.Input[builtins.str] project_id: `project_id`) The ID of the project the WAF stage is associated with.
        :param pulumi.Input[builtins.str] updated_at: The date and time of the last update of the WAF stage.
        """
        if backend_stage_id is not None:
            pulumi.set(__self__, "backend_stage_id", backend_stage_id)
...
class EdgeServicesWafStage(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            pipeline_id: Optional[pulumi.Input[builtins.str]] = None,
            project_id: Optional[pulumi.Input[builtins.str]] = None,
            updated_at: Optional[pulumi.Input[builtins.str]] = None) -> 'EdgeServicesWafStage':
        """
