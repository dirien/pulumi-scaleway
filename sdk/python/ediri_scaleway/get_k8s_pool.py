...
__all__ = [
    'GetK8sPoolResult',
    'AwaitableGetK8sPoolResult',
    'get_k8s_pool',
    'get_k8s_pool_output',
]

@pulumi.output_type
class GetK8sPoolResult:
    """
    ...
    @property
    @pulumi.getter
    def autohealing(self) -> builtins.bool:
        """
    ...
    @property
    @pulumi.getter
    def autoscaling(self) -> builtins.bool:
        """
    ...
    def kubelet_args(self) -> Mapping[str, builtins.str]:
    ...
    @property
    @pulumi.getter
    def nodes(self) -> Sequence['outputs.GetK8sPoolNodeResult']:
        """
    ...
    def public_ip_disabled(self) -> builtins.bool:
    ...
    def root_volume_size_in_gb(self) -> builtins.int:
    ...
    def upgrade_policies(self) -> Sequence['outputs.GetK8sPoolUpgradePolicyResult']:
    ...
    def wait_for_pool_ready(self) -> builtins.bool:
...
class AwaitableGetK8sPoolResult(GetK8sPoolResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetK8sPoolResult(
...
def get_k8s_pool(cluster_id: Optional[builtins.str] = None,
                 name: Optional[builtins.str] = None,
                 pool_id: Optional[builtins.str] = None,
                 region: Optional[builtins.str] = None,
                 size: Optional[builtins.int] = None,
                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetK8sPoolResult:
    """
    ...
    :param builtins.str cluster_id: The cluster ID. Required when `name` is set.
    ...
    :param builtins.str pool_id: The pool's ID. Only one of `name` and `pool_id` should be specified.
    :param builtins.str region: `region`) The region in which the pool exists.
    :param builtins.int size: The size of the pool.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('scaleway:index/getK8sPool:getK8sPool', __args__, opts=opts, typ=GetK8sPoolResult).value

    return AwaitableGetK8sPoolResult(
...
def get_k8s_pool_output(cluster_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
