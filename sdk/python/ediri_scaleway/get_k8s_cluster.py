...
class GetK8sClusterResult:
    ...
    def admission_plugins(self) -> Sequence[builtins.str]:
        """
    ...
    def apiserver_cert_sans(self) -> Sequence[builtins.str]:
        return pulumi.get(self, "apiserver_cert_sans")

    @property
    @pulumi.getter(name="apiserverUrl")
    def apiserver_url(self) -> builtins.str:
        """
    ...
    def auto_upgrades(self) -> Sequence['outputs.GetK8sClusterAutoUpgradeResult']:
        """
    ...
    def autoscaler_configs(self) -> Sequence['outputs.GetK8sClusterAutoscalerConfigResult']:
        """
    ...
    def feature_gates(self) -> Sequence[builtins.str]:
        """
    ...
    @property
    @pulumi.getter
    def kubeconfigs(self) -> Sequence['outputs.GetK8sClusterKubeconfigResult']:
    ...
    def open_id_connect_configs(self) -> Sequence['outputs.GetK8sClusterOpenIdConnectConfigResult']:
    ...
    def upgrade_available(self) -> builtins.bool:
        """
    ...
    def wildcard_dns(self) -> builtins.str:
        """
...
def get_k8s_cluster(cluster_id: Optional[builtins.str] = None,
    ...
    :param builtins.str cluster_id: The cluster ID. Only one of `name` and `cluster_id` should be specified.
    :param builtins.str name: The cluster name. Only one of `name` and `cluster_id` should be specified.
    :param builtins.str project_id: The ID of the project the cluster is associated with.
    :param builtins.str region: `region`) The region in which the cluster exists.
    """
    __args__ = dict()
...
def get_k8s_cluster_output(cluster_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
