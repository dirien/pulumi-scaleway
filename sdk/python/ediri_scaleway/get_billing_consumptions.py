...
def get_billing_consumptions(project_id: Optional[builtins.str] = None,
...
def get_billing_consumptions_output(project_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
