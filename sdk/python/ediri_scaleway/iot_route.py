...
class IotRouteArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] hub_id: The hub ID to which the Route will be attached to.
        :param pulumi.Input[builtins.str] topic: The topic the Route subscribes to, wildcards allowed (e.g. `thelab/+/temperature/#`).
        ...
        :param pulumi.Input[builtins.str] name: The name of the IoT Route you want to create (e.g. `my-route`).
        :param pulumi.Input[builtins.str] region: (Defaults to provider `region`) The region in which the Route is attached to.
...
class _IotRouteState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] created_at: The date and time the Route was created.
        :param pulumi.Input['IotRouteDatabaseArgs'] database: Configuration block for the database routes. See  [product documentation](https://www.scaleway.com/en/docs/iot-hub/how-to/create-route/) for a better understanding of the parameters.
        :param pulumi.Input[builtins.str] hub_id: The hub ID to which the Route will be attached to.
        :param pulumi.Input[builtins.str] name: The name of the IoT Route you want to create (e.g. `my-route`).
        :param pulumi.Input[builtins.str] region: (Defaults to provider `region`) The region in which the Route is attached to.
...
class IotRoute(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            rest: Optional[pulumi.Input[Union['IotRouteRestArgs', 'IotRouteRestArgsDict']]] = None,
            s3: Optional[pulumi.Input[Union['IotRouteS3Args', 'IotRouteS3ArgsDict']]] = None,
            topic: Optional[pulumi.Input[builtins.str]] = None) -> 'IotRoute':
        """
