...
class ObjectBucketArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] object_lock_enabled: Enable object lock
        :param pulumi.Input[builtins.str] project_id: `project_id`) The ID of the project the bucket is associated with.
        :param pulumi.Input[builtins.str] region: The [region](https://www.scaleway.com/en/developers/api/#region-definition) in which the bucket will be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A list of tags (key/value) for the bucket.
