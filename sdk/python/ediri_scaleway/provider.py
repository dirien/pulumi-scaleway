...
class ProviderArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] access_key: The Scaleway access key.
        :param pulumi.Input[builtins.str] api_url: The Scaleway API URL to use.
        :param pulumi.Input[builtins.str] organization_id: The Scaleway organization ID.
        :param pulumi.Input[builtins.str] profile: The Scaleway profile to use.
        ...
        :param pulumi.Input[builtins.str] secret_key: The Scaleway secret Key.
...
@pulumi.type_token("pulumi:providers:scaleway")
class Provider(pulumi.ProviderResource):
    ...
    def terraform_config(__self__) -> pulumi.Output['Provider.TerraformConfigResult']:
        ...
        return pulumi.runtime.call('pulumi:providers:scaleway/terraformConfig', __args__, res=__self__, typ=Provider.TerraformConfigResult)
