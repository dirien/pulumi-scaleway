...
class _ObjectBucketWebsiteConfigurationState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] project_id: The project_id you want to attach the resource to
        :param pulumi.Input[builtins.str] region: The region you want to attach the resource to
        :param pulumi.Input[builtins.str] website_domain: The domain of the website endpoint. This is used to create DNS alias [records](https://www.scaleway.com/en/docs/network/domains-and-dns/how-to/manage-dns-records/).
        :param pulumi.Input[builtins.str] website_endpoint: The website endpoint.
        """
...
class ObjectBucketWebsiteConfiguration(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test_object_bucket = scaleway.ObjectBucket("testObjectBucket", acl="public-read")
        some_file = scaleway.ObjectItem("someFile",
            bucket=test_object_bucket.name,
            key="index.html",
            file="index.html",
            visibility="public-read",
            content_type="text/html")
        test_object_bucket_website_configuration = scaleway.ObjectBucketWebsiteConfiguration("testObjectBucketWebsiteConfiguration",
            bucket=test_object_bucket.name,
            index_document={
                "suffix": "index.html",
            },
    ...
    def get(resource_name: str,
            ...
            region: Optional[pulumi.Input[builtins.str]] = None,
            website_domain: Optional[pulumi.Input[builtins.str]] = None,
            website_endpoint: Optional[pulumi.Input[builtins.str]] = None) -> 'ObjectBucketWebsiteConfiguration':
        """
