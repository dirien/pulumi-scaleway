...
@pulumi.type_token("scaleway:index/lbRoute:LbRoute")
class LbRoute(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        lb = scaleway.Lb("lb",
            ip_id=ip.id,
            type="lb-s")
        app = scaleway.LbBackend("app",
            lb_id=lb.id,
            forward_protocol="http",
            forward_port=80,
            proxy_protocol="none")
        admin = scaleway.LbBackend("admin",
            lb_id=lb.id,
            forward_protocol="http",
            forward_port=8080,
            proxy_protocol="none")
        frontend = scaleway.LbFrontend("frontend",
            lb_id=lb.id,
            backend_id=app.id,
            inbound_port=80)
        admin_route = scaleway.LbRoute("adminRoute",
            frontend_id=frontend.id,
            backend_id=admin.id,
            match_path_begin="/admin")
        default_route = scaleway.LbRoute("defaultRoute",
            frontend_id=frontend.id,
            backend_id=app.id,
            match_path_begin="/")
        ```
    ...
    def get(resource_name: str,
            ...
            match_sni: Optional[pulumi.Input[builtins.str]] = None,
            match_subdomains: Optional[pulumi.Input[builtins.bool]] = None,
            updated_at: Optional[pulumi.Input[builtins.str]] = None) -> 'LbRoute':
        """
