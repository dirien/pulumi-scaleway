...
class SecretVersionInitArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] data: The data payload of the secret version. Must not exceed 64KiB in size (e.g. `my-secret-version-payload`). Find out more on the [data section](https://www.terraform.io/#data-information).
        :param pulumi.Input[builtins.str] secret_id: The ID of the secret associated with the version.
        :param pulumi.Input[builtins.str] description: Description of the secret version (e.g. `my-new-description`).
        :param pulumi.Input[builtins.str] region: ). The region where the resource exists.
        """
...
class _SecretVersionState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] created_at: The date and time of the secret version's creation (in RFC 3339 format).
        :param pulumi.Input[builtins.str] data: The data payload of the secret version. Must not exceed 64KiB in size (e.g. `my-secret-version-payload`). Find out more on the [data section](https://www.terraform.io/#data-information).
        :param pulumi.Input[builtins.str] description: Description of the secret version (e.g. `my-new-description`).
        :param pulumi.Input[builtins.str] region: ). The region where the resource exists.
        :param pulumi.Input[builtins.str] revision: The revision number of the secret version.
        :param pulumi.Input[builtins.str] secret_id: The ID of the secret associated with the version.
        :param pulumi.Input[builtins.str] status: The status of the secret version.
        :param pulumi.Input[builtins.str] updated_at: The date and time of the secret version's last update (in RFC 3339 format).
        """
...
@pulumi.type_token("scaleway:index/secretVersion:SecretVersion")
class SecretVersion(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            secret_id: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            updated_at: Optional[pulumi.Input[builtins.str]] = None) -> 'SecretVersion':
        """
