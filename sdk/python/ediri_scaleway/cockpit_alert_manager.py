...
class CockpitAlertManagerArgs:
    def __init__(__self__, *,
                 ...
                 enable_managed_alerts: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.bool] enable_managed_alerts: Specifies whether the alert manager should be enabled. Defaults to true.
        :param pulumi.Input[builtins.str] project_id: ) The ID of the Project the Cockpit is associated with.
        :param pulumi.Input[builtins.str] region: ) The region where the [alert manager](https://www.scaleway.com/en/docs/observability/cockpit/concepts/#alert-manager) should be enabled.
        """
    ...
    def enable_managed_alerts(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_managed_alerts(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _CockpitAlertManagerState:
    def __init__(__self__, *,
                 alert_manager_url: Optional[pulumi.Input[builtins.str]] = None,
                 contact_points: Optional[pulumi.Input[Sequence[pulumi.Input['CockpitAlertManagerContactPointArgs']]]] = None,
                 enable_managed_alerts: Optional[pulumi.Input[builtins.bool]] = None,
                 project_id: Optional[pulumi.Input[builtins.str]] = None,
                 region: Optional[pulumi.Input[builtins.str]] = None):
        ...
        :param pulumi.Input[builtins.str] alert_manager_url: The URL of the alert manager.
        :param pulumi.Input[Sequence[pulumi.Input['CockpitAlertManagerContactPointArgs']]] contact_points: A list of contact points with email addresses that will receive alerts. Each map should contain a single key email.
        :param pulumi.Input[builtins.bool] enable_managed_alerts: Specifies whether the alert manager should be enabled. Defaults to true.
        :param pulumi.Input[builtins.str] project_id: ) The ID of the Project the Cockpit is associated with.
        :param pulumi.Input[builtins.str] region: ) The region where the [alert manager](https://www.scaleway.com/en/docs/observability/cockpit/concepts/#alert-manager) should be enabled.
    ...
    def alert_manager_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def alert_manager_url(self, value: Optional[pulumi.Input[builtins.str]]):
...
class CockpitAlertManager(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        alert_manager = scaleway.CockpitAlertManager("alertManager",
    ...
    def get(resource_name: str,
            ...
            enable_managed_alerts: Optional[pulumi.Input[builtins.bool]] = None,
            project_id: Optional[pulumi.Input[builtins.str]] = None,
            region: Optional[pulumi.Input[builtins.str]] = None) -> 'CockpitAlertManager':
        """
    ...
    @property
    @pulumi.getter(name="alertManagerUrl")
    def alert_manager_url(self) -> pulumi.Output[builtins.str]:
        """
        The URL of the alert manager.
        """
        return pulumi.get(self, "alert_manager_url")
    ...
    @property
    @pulumi.getter(name="enableManagedAlerts")
    def enable_managed_alerts(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether the alert manager should be enabled. Defaults to true.
        """
        return pulumi.get(self, "enable_managed_alerts")
