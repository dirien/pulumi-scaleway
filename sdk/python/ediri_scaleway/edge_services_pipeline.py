...
class EdgeServicesPipeline(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        main = scaleway.EdgeServicesPipeline("main", description="pipeline description")
        ```
        ...
        main_edge_services_pipeline = scaleway.EdgeServicesPipeline("mainEdgeServicesPipeline", description="pipeline description")
        main_edge_services_backend_stage = scaleway.EdgeServicesBackendStage("mainEdgeServicesBackendStage",
            pipeline_id=main_edge_services_pipeline.id,
            s3_backend_config={
                "bucket_name": "my-bucket-name",
                "bucket_region": "fr-par",
            })
        main_edge_services_waf_stage = scaleway.EdgeServicesWafStage("mainEdgeServicesWafStage",
            pipeline_id=main_edge_services_pipeline.id,
            backend_stage_id=main_edge_services_backend_stage.id,
            mode="enable",
            paranoia_level=3)
        main_edge_services_route_stage = scaleway.EdgeServicesRouteStage("mainEdgeServicesRouteStage",
            pipeline_id=main_edge_services_pipeline.id,
        ...
        main_edge_services_cache_stage = scaleway.EdgeServicesCacheStage("mainEdgeServicesCacheStage",
            pipeline_id=main_edge_services_pipeline.id,
            route_stage_id=main_edge_services_route_stage.id)
        main_edge_services_tls_stage = scaleway.EdgeServicesTlsStage("mainEdgeServicesTlsStage",
            pipeline_id=main_edge_services_pipeline.id,
            cache_stage_id=main_edge_services_cache_stage.id,
            managed_certificate=True)
        main_edge_services_dns_stage = scaleway.EdgeServicesDnsStage("mainEdgeServicesDnsStage",
            pipeline_id=main_edge_services_pipeline.id,
            tls_stage_id=main_edge_services_tls_stage.id,
            fqdns=["subdomain.example.com"])
        main_edge_services_head_stage = scaleway.EdgeServicesHeadStage("mainEdgeServicesHeadStage",
            pipeline_id=main_edge_services_pipeline.id,
