...
__all__ = [
    'GetRdbDatabaseResult',
    'AwaitableGetRdbDatabaseResult',
    'get_rdb_database',
    'get_rdb_database_output',
]

@pulumi.output_type
class GetRdbDatabaseResult:
    """
...
class AwaitableGetRdbDatabaseResult(GetRdbDatabaseResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetRdbDatabaseResult(
            id=self.id,
...
def get_rdb_database(instance_id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('scaleway:index/getRdbDatabase:getRdbDatabase', __args__, opts=opts, typ=GetRdbDatabaseResult).value

    return AwaitableGetRdbDatabaseResult(
...
def get_rdb_database_output(instance_id: Optional[pulumi.Input[builtins.str]] = None,
