...
__all__ = [
    'GetTemOfferSubscriptionResult',
    'AwaitableGetTemOfferSubscriptionResult',
    'get_tem_offer_subscription',
    'get_tem_offer_subscription_output',
]

@pulumi.output_type
class GetTemOfferSubscriptionResult:
    """
...
class AwaitableGetTemOfferSubscriptionResult(GetTemOfferSubscriptionResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetTemOfferSubscriptionResult(
...
def get_tem_offer_subscription(project_id: Optional[builtins.str] = None,
                               region: Optional[builtins.str] = None,
                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetTemOfferSubscriptionResult:
    """
    ...
    test = scaleway.get_tem_offer_subscription()
    ```
    ...
    __ret__ = pulumi.runtime.invoke('scaleway:index/getTemOfferSubscription:getTemOfferSubscription', __args__, opts=opts, typ=GetTemOfferSubscriptionResult).value

    return AwaitableGetTemOfferSubscriptionResult(
...
def get_tem_offer_subscription_output(project_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                      region: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                      opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetTemOfferSubscriptionResult]:
    """
    Gets information about a transactional email offer subscription.
    ...
    __ret__ = pulumi.runtime.invoke_output('scaleway:index/getTemOfferSubscription:getTemOfferSubscription', __args__, opts=opts, typ=GetTemOfferSubscriptionResult)
    return __ret__.apply(lambda __response__: GetTemOfferSubscriptionResult(
