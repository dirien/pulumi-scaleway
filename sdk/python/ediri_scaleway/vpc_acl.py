...
__all__ = ['VpcAclArgs', 'VpcAcl']

@pulumi.input_type
class VpcAclArgs:
    def __init__(__self__, *,
                 default_policy: pulumi.Input[builtins.str],
                 rules: pulumi.Input[Sequence[pulumi.Input['VpcAclRuleArgs']]],
        ...
        :param pulumi.Input[Sequence[pulumi.Input['VpcAclRuleArgs']]] rules: The list of Network ACL rules.
    ...
    @property
    @pulumi.getter
    def rules(self) -> pulumi.Input[Sequence[pulumi.Input['VpcAclRuleArgs']]]:
        """
    ...
    @rules.setter
    def rules(self, value: pulumi.Input[Sequence[pulumi.Input['VpcAclRuleArgs']]]):
...
class _VpcAclState:
    def __init__(__self__, *,
                 ...
                 is_ipv6: Optional[pulumi.Input[builtins.bool]] = None,
                 region: Optional[pulumi.Input[builtins.str]] = None,
                 rules: Optional[pulumi.Input[Sequence[pulumi.Input['VpcAclRuleArgs']]]] = None,
    ...
    @property
    @pulumi.getter
    def rules(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['VpcAclRuleArgs']]]]:
        """
        The list of Network ACL rules.
        """
        return pulumi.get(self, "rules")
    ...
    @rules.setter
    def rules(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['VpcAclRuleArgs']]]]):
        pulumi.set(self, "rules", value)
...
@pulumi.type_token("scaleway:index/vpcAcl:VpcAcl")
class VpcAcl(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 is_ipv6: Optional[pulumi.Input[builtins.bool]] = None,
                 region: Optional[pulumi.Input[builtins.str]] = None,
                 rules: Optional[pulumi.Input[Sequence[pulumi.Input[Union['VpcAclRuleArgs', 'VpcAclRuleArgsDict']]]]] = None,
                 vpc_id: Optional[pulumi.Input[builtins.str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[builtins.bool] is_ipv6: Defines whether this set of ACL rules is for IPv6 (false = IPv4). Each Network ACL can have rules for only one IP type.
        :param pulumi.Input[builtins.str] region: `region`) The region of the ACL.
        :param pulumi.Input[Sequence[pulumi.Input[Union['VpcAclRuleArgs', 'VpcAclRuleArgsDict']]]] rules: The list of Network ACL rules.
        :param pulumi.Input[builtins.str] vpc_id: The VPC ID the ACL belongs to.
        """
        ...
    @overload
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param VpcAclArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(VpcAclArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = VpcAclArgs.__new__(VpcAclArgs)
        ...
        super(VpcAcl, __self__).__init__(
            'scaleway:index/vpcAcl:VpcAcl',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            region: Optional[pulumi.Input[builtins.str]] = None,
            rules: Optional[pulumi.Input[Sequence[pulumi.Input[Union['VpcAclRuleArgs', 'VpcAclRuleArgsDict']]]]] = None,
            vpc_id: Optional[pulumi.Input[builtins.str]] = None) -> 'VpcAcl':
        """
        ...
        __props__ = _VpcAclState.__new__(_VpcAclState)
        ...
        __props__.__dict__["rules"] = rules
        __props__.__dict__["vpc_id"] = vpc_id
        return VpcAcl(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def rules(self) -> pulumi.Output[Sequence['outputs.VpcAclRule']]:
        """
        The list of Network ACL rules.
        """
        return pulumi.get(self, "rules")
