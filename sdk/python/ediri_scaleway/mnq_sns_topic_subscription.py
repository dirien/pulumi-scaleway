...
class MnqSnsTopicSubscriptionArgs:
    def __init__(__self__, *,
                 ...
                 redrive_policy: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] protocol: Protocol of the SNS topic subscription.
        :param pulumi.Input[builtins.str] secret_key: The secret key of the SNS credentials.
        :param pulumi.Input[builtins.str] endpoint: Endpoint of the subscription
        :param pulumi.Input[builtins.str] project_id: `project_id`) The ID of the Project in which SNS is enabled.
        :param pulumi.Input[builtins.bool] redrive_policy: Activate JSON redrive policy.
        ...
        :param pulumi.Input[builtins.str] topic_arn: The ARN of the topic. Either `topic_id` or `topic_arn` is required.
        :param pulumi.Input[builtins.str] topic_id: The ID of the topic. Either `topic_id` or `topic_arn` is required. Conflicts with `topic_arn`.
        """
    ...
    def redrive_policy(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def redrive_policy(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _MnqSnsTopicSubscriptionState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] access_key: The access key of the SNS credentials.
        :param pulumi.Input[builtins.str] arn: The ARN of the topic subscription
        :param pulumi.Input[builtins.str] endpoint: Endpoint of the subscription
        :param pulumi.Input[builtins.str] project_id: `project_id`) The ID of the Project in which SNS is enabled.
        :param pulumi.Input[builtins.str] protocol: Protocol of the SNS topic subscription.
        :param pulumi.Input[builtins.bool] redrive_policy: Activate JSON redrive policy.
...
class MnqSnsTopicSubscription(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            sns_endpoint: Optional[pulumi.Input[builtins.str]] = None,
            topic_arn: Optional[pulumi.Input[builtins.str]] = None,
            topic_id: Optional[pulumi.Input[builtins.str]] = None) -> 'MnqSnsTopicSubscription':
        """
    ...
    @property
    @pulumi.getter(name="redrivePolicy")
    def redrive_policy(self) -> pulumi.Output[builtins.bool]:
        """
        Activate JSON redrive policy.
        """
        return pulumi.get(self, "redrive_policy")
