...
class FunctionCronArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] args: The key-value mapping to define arguments that will be passed to your function’s event object
        :param pulumi.Input[builtins.str] function_id: The unique identifier of the function to link to your CRON trigger.
        :param pulumi.Input[builtins.str] schedule: CRON format string (refer to the [CRON schedule reference](https://www.scaleway.com/en/docs/serverless/functions/reference-content/cron-schedules/) for more information).
        :param pulumi.Input[builtins.str] name: The name of the function CRON trigger. If not provided, a random name is generated.
...
@pulumi.type_token("scaleway:index/functionCron:FunctionCron")
class FunctionCron(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            region: Optional[pulumi.Input[builtins.str]] = None,
            schedule: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'FunctionCron':
        """
