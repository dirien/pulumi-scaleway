...
class FunctionTokenArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] namespace_id: The unique identifier of the Functions namespace.
...
@pulumi.type_token("scaleway:index/functionToken:FunctionToken")
class FunctionToken(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            namespace_id: Optional[pulumi.Input[builtins.str]] = None,
            region: Optional[pulumi.Input[builtins.str]] = None,
            token: Optional[pulumi.Input[builtins.str]] = None) -> 'FunctionToken':
        """
