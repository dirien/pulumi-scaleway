...
def get_ipam_ips(attached: Optional[builtins.bool] = None,
    ...
    :param builtins.bool attached: Defines whether to filter only for IPs which are attached to a resource.
    :param builtins.str mac_address: The linked MAC address to filter for.
    :param builtins.str private_network_id: The ID of the Private Network to filter for.
    ...
    :param builtins.str type: The type of IP to filter for (`ipv4` or `ipv6`).
...
def get_ipam_ips_output(attached: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
