...
class GetBaremetalServerResult:
    ...
    def install_config_afterward(self) -> builtins.bool:
    ...
    @property
    @pulumi.getter
    def partitioning(self) -> builtins.str:
    ...
    def service_user(self) -> builtins.str:
        return pulumi.get(self, "service_user")

    @property
    @pulumi.getter(name="sshKeyIds")
    def ssh_key_ids(self) -> Sequence[builtins.str]:
...
def get_baremetal_server(name: Optional[builtins.str] = None,
    ...
    :param builtins.str project_id: The ID of the project the baremetal server is associated with.
...
def get_baremetal_server_output(name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
