...
class VpcPublicGatewayDhcpReservationArgs:
    def __init__(__self__, *,
                 gateway_network_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] gateway_network_id: The ID of the owning GatewayNetwork.
        :param pulumi.Input[builtins.str] ip_address: The IP address to give to the machine.
        :param pulumi.Input[builtins.str] mac_address: The MAC address for the static entry.
        :param pulumi.Input[builtins.str] zone: `zone`) The zone in which the public gateway DHCP config should be created.
        """
    ...
    def gateway_network_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def gateway_network_id(self, value: pulumi.Input[builtins.str]):
...
class _VpcPublicGatewayDhcpReservationState:
    def __init__(__self__, *,
                 ...
                 gateway_network_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] gateway_network_id: The ID of the owning GatewayNetwork.
        :param pulumi.Input[builtins.str] hostname: The hostname of the client machine.
        :param pulumi.Input[builtins.str] ip_address: The IP address to give to the machine.
        :param pulumi.Input[builtins.str] mac_address: The MAC address for the static entry.
        :param pulumi.Input[builtins.str] type: The reservation type, either static (DHCP reservation) or dynamic (DHCP lease). Possible values are `reservation` and `lease`.
    ...
    @property
    @pulumi.getter(name="gatewayNetworkId")
    def gateway_network_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the owning GatewayNetwork.
        """
        return pulumi.get(self, "gateway_network_id")
    ...
    @gateway_network_id.setter
    def gateway_network_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "gateway_network_id", value)
...
class VpcPublicGatewayDhcpReservation(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        > **Important:**  The resource `VpcPublicGatewayDhcpReservation` has been deprecated and will no longer be supported.
    ...
    def get(resource_name: str,
            ...
            type: Optional[pulumi.Input[builtins.str]] = None,
            updated_at: Optional[pulumi.Input[builtins.str]] = None,
            zone: Optional[pulumi.Input[builtins.str]] = None) -> 'VpcPublicGatewayDhcpReservation':
        """
    ...
    @property
    @pulumi.getter(name="gatewayNetworkId")
    def gateway_network_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the owning GatewayNetwork.
        """
        return pulumi.get(self, "gateway_network_id")
