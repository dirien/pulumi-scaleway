...
class SecretArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: Name of the secret (e.g. `my-secret`).
        :param pulumi.Input[builtins.str] path: Path of the secret, defaults to `/`.
        :param pulumi.Input[builtins.str] project_id: The project ID containing is the secret.
        :param pulumi.Input[builtins.bool] protected: True if secret protection is enabled on a given secret. A protected secret cannot be deleted.
        :param pulumi.Input[builtins.str] region: `region`) The region
               in which the resource exists.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: Tags of the secret (e.g. `["tag", "secret"]`).
...
class _SecretState:
    def __init__(__self__, *,
                 ...
                 version_count: Optional[pulumi.Input[builtins.int]] = None,
    ...
    def version_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def version_count(self, value: Optional[pulumi.Input[builtins.int]]):
...
class Secret(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="versionCount")
    def version_count(self) -> pulumi.Output[builtins.int]:
        """
        The amount of secret versions.
        """
        return pulumi.get(self, "version_count")
