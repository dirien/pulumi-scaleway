...
class GetLbBackendResult:
    ...
    def backend_id(self) -> Optional[builtins.str]:
    ...
    def health_check_send_proxy(self) -> builtins.bool:
    ...
    def health_check_transient_delay(self) -> builtins.str:
    ...
    def redispatch_attempt_count(self) -> builtins.int:
        return pulumi.get(self, "redispatch_attempt_count")

    @property
    @pulumi.getter(name="sendProxyV2")
    def send_proxy_v2(self) -> builtins.bool:
    ...
    def timeout_queue(self) -> builtins.str:
...
def get_lb_backend(backend_id: Optional[builtins.str] = None,
    ...
    :param builtins.str backend_id: The backend ID.
           - Only one of `name` and `backend_id` should be specified.
    :param builtins.str lb_id: Load Balancer ID this backend is attached to.
    :param builtins.str name: The name of the backend.
...
def get_lb_backend_output(backend_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
