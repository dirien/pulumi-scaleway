...
class IamApplicationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: The description of the iam application.
        :param pulumi.Input[builtins.str] name: The name of the iam application.
        :param pulumi.Input[builtins.str] organization_id: `organization_id`) The ID of the organization the application is associated with.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: The tags associated with the application.
        """
...
class _IamApplicationState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] created_at: The date and time of the creation of the application.
        :param pulumi.Input[builtins.str] description: The description of the iam application.
        :param pulumi.Input[builtins.bool] editable: Whether the application is editable.
        :param pulumi.Input[builtins.str] name: The name of the iam application.
        :param pulumi.Input[builtins.str] organization_id: `organization_id`) The ID of the organization the application is associated with.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: The tags associated with the application.
        :param pulumi.Input[builtins.str] updated_at: The date and time of the last update of the application.
        """
...
@pulumi.type_token("scaleway:index/iamApplication:IamApplication")
class IamApplication(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            organization_id: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            updated_at: Optional[pulumi.Input[builtins.str]] = None) -> 'IamApplication':
        """
