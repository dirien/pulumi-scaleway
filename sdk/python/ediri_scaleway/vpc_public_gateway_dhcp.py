...
class VpcPublicGatewayDhcpArgs:
    def __init__(__self__, *,
                 ...
                 dns_local_name: Optional[pulumi.Input[builtins.str]] = None,
                 dns_searches: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 dns_servers_overrides: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 enable_dynamic: Optional[pulumi.Input[builtins.bool]] = None,
                 pool_high: Optional[pulumi.Input[builtins.str]] = None,
                 pool_low: Optional[pulumi.Input[builtins.str]] = None,
                 project_id: Optional[pulumi.Input[builtins.str]] = None,
                 push_default_route: Optional[pulumi.Input[builtins.bool]] = None,
                 push_dns_server: Optional[pulumi.Input[builtins.bool]] = None,
                 rebind_timer: Optional[pulumi.Input[builtins.int]] = None,
                 renew_timer: Optional[pulumi.Input[builtins.int]] = None,
                 valid_lifetime: Optional[pulumi.Input[builtins.int]] = None,
                 zone: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a VpcPublicGatewayDhcp resource.
        :param pulumi.Input[builtins.str] subnet: The subnet to associate with the Public Gateway DHCP configuration.
        :param pulumi.Input[builtins.str] address: The IP address of the DHCP server. This will be the gateway's address in the Private Network.
        :param pulumi.Input[builtins.str] dns_local_name: TLD given to hostnames in the Private Network. Allowed characters are `a-z0-9-.`. Defaults to the slugified Private Network name if created along a GatewayNetwork, or else to `priv`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] dns_searches: Additional DNS search paths
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] dns_servers_overrides: Override the DNS server list pushed to DHCP clients, instead of the gateway itself.
        :param pulumi.Input[builtins.bool] enable_dynamic: Whether to enable dynamic pooling of IPs. By turning the dynamic pool off, only pre-existing DHCP reservations will be handed out. Defaults to `true`.
        :param pulumi.Input[builtins.str] pool_high: High IP (excluded) of the dynamic address pool. Defaults to the last address of the subnet.
        :param pulumi.Input[builtins.str] pool_low: Low IP (included) of the dynamic address pool. Defaults to the second address of the subnet.
        :param pulumi.Input[builtins.str] project_id: `project_id`) The ID of the Project the Public Gateway DHCP configuration is associated with.
        :param pulumi.Input[builtins.bool] push_default_route: Whether the gateway should push a default route to DHCP clients or only hand out IPs. Defaults to `true`.
               
               > **Warning**: If you need to setup a default route, it's recommended to use the `VpcGatewayNetwork` resource instead.
        :param pulumi.Input[builtins.bool] push_dns_server: Whether the gateway should push custom DNS servers to clients. This allows for instance hostname > IP resolution. Defaults to `true`.
        :param pulumi.Input[builtins.int] rebind_timer: After how long, in seconds, a DHCP client will query for a new lease if previous renews fail. Must be 30s lower than `valid_lifetime`. Defaults to 51m (3060s).
        :param pulumi.Input[builtins.int] renew_timer: After how long, in seconds, a renewal will be attempted. Must be 30s lower than `rebind_timer`. Defaults to 50m (3000s).
        :param pulumi.Input[builtins.int] valid_lifetime: How long, in seconds, DHCP entries will be valid. Defaults to 1h (3600s).
    ...
    def dns_local_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def dns_local_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def dns_servers_overrides(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def dns_servers_overrides(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "dns_servers_overrides", value)

    @property
    @pulumi.getter(name="enableDynamic")
    def enable_dynamic(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_dynamic(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "enable_dynamic", value)

    @property
    @pulumi.getter(name="poolHigh")
    def pool_high(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @pool_high.setter
    def pool_high(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "pool_high", value)

    @property
    @pulumi.getter(name="poolLow")
    def pool_low(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @pool_low.setter
    def pool_low(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def push_dns_server(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def push_dns_server(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "push_dns_server", value)

    @property
    @pulumi.getter(name="rebindTimer")
    def rebind_timer(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @rebind_timer.setter
    def rebind_timer(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "rebind_timer", value)

    @property
    @pulumi.getter(name="renewTimer")
    def renew_timer(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @renew_timer.setter
    def renew_timer(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "renew_timer", value)

    @property
    @pulumi.getter(name="validLifetime")
    def valid_lifetime(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def valid_lifetime(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _VpcPublicGatewayDhcpState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] address: The IP address of the DHCP server. This will be the gateway's address in the Private Network.
        :param pulumi.Input[builtins.str] created_at: The date and time of the creation of the Public Gateway DHCP configuration.
        :param pulumi.Input[builtins.str] dns_local_name: TLD given to hostnames in the Private Network. Allowed characters are `a-z0-9-.`. Defaults to the slugified Private Network name if created along a GatewayNetwork, or else to `priv`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] dns_searches: Additional DNS search paths
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] dns_servers_overrides: Override the DNS server list pushed to DHCP clients, instead of the gateway itself.
        :param pulumi.Input[builtins.bool] enable_dynamic: Whether to enable dynamic pooling of IPs. By turning the dynamic pool off, only pre-existing DHCP reservations will be handed out. Defaults to `true`.
        :param pulumi.Input[builtins.str] organization_id: The Organization ID the Public Gateway DHCP config is associated with.
        :param pulumi.Input[builtins.str] pool_high: High IP (excluded) of the dynamic address pool. Defaults to the last address of the subnet.
        :param pulumi.Input[builtins.str] pool_low: Low IP (included) of the dynamic address pool. Defaults to the second address of the subnet.
        :param pulumi.Input[builtins.str] project_id: `project_id`) The ID of the Project the Public Gateway DHCP configuration is associated with.
        :param pulumi.Input[builtins.bool] push_default_route: Whether the gateway should push a default route to DHCP clients or only hand out IPs. Defaults to `true`.
        ...
        :param pulumi.Input[builtins.int] renew_timer: After how long, in seconds, a renewal will be attempted. Must be 30s lower than `rebind_timer`. Defaults to 50m (3000s).
        :param pulumi.Input[builtins.str] subnet: The subnet to associate with the Public Gateway DHCP configuration.
        :param pulumi.Input[builtins.str] updated_at: The date and time of the last update of the Public Gateway DHCP configuration.
        :param pulumi.Input[builtins.int] valid_lifetime: How long, in seconds, DHCP entries will be valid. Defaults to 1h (3600s).
        :param pulumi.Input[builtins.str] zone: `zone`) The zone in which the Public Gateway DHCP configuration should be created.
        """
        if address is not None:
...
class VpcPublicGatewayDhcp(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        > **Important:**  The resource `VpcPublicGatewayDhcp` has been deprecated and will no longer be supported.
    ...
    def get(resource_name: str,
            ...
            updated_at: Optional[pulumi.Input[builtins.str]] = None,
            valid_lifetime: Optional[pulumi.Input[builtins.int]] = None,
            zone: Optional[pulumi.Input[builtins.str]] = None) -> 'VpcPublicGatewayDhcp':
        """
    ...
    @property
    @pulumi.getter(name="dnsLocalName")
    def dns_local_name(self) -> pulumi.Output[builtins.str]:
        """
        TLD given to hostnames in the Private Network. Allowed characters are `a-z0-9-.`. Defaults to the slugified Private Network name if created along a GatewayNetwork, or else to `priv`.
        """
        return pulumi.get(self, "dns_local_name")
    ...
    @property
    @pulumi.getter(name="dnsSearches")
    def dns_searches(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Additional DNS search paths
        """
        return pulumi.get(self, "dns_searches")
    ...
    @property
    @pulumi.getter(name="dnsServersOverrides")
    def dns_servers_overrides(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Override the DNS server list pushed to DHCP clients, instead of the gateway itself.
        """
        return pulumi.get(self, "dns_servers_overrides")
    ...
    @property
    @pulumi.getter(name="enableDynamic")
    def enable_dynamic(self) -> pulumi.Output[builtins.bool]:
        """
        Whether to enable dynamic pooling of IPs. By turning the dynamic pool off, only pre-existing DHCP reservations will be handed out. Defaults to `true`.
        """
        return pulumi.get(self, "enable_dynamic")
    ...
    @property
    @pulumi.getter(name="poolHigh")
    def pool_high(self) -> pulumi.Output[builtins.str]:
        """
        High IP (excluded) of the dynamic address pool. Defaults to the last address of the subnet.
        """
        return pulumi.get(self, "pool_high")
    ...
    @property
    @pulumi.getter(name="poolLow")
    def pool_low(self) -> pulumi.Output[builtins.str]:
        """
        Low IP (included) of the dynamic address pool. Defaults to the second address of the subnet.
        """
        return pulumi.get(self, "pool_low")
    ...
    @property
    @pulumi.getter(name="pushDefaultRoute")
    def push_default_route(self) -> pulumi.Output[builtins.bool]:
        """
        Whether the gateway should push a default route to DHCP clients or only hand out IPs. Defaults to `true`.
    ...
    @property
    @pulumi.getter(name="pushDnsServer")
    def push_dns_server(self) -> pulumi.Output[builtins.bool]:
        """
        Whether the gateway should push custom DNS servers to clients. This allows for instance hostname > IP resolution. Defaults to `true`.
        """
        return pulumi.get(self, "push_dns_server")
    ...
    @property
    @pulumi.getter(name="rebindTimer")
    def rebind_timer(self) -> pulumi.Output[builtins.int]:
        """
        After how long, in seconds, a DHCP client will query for a new lease if previous renews fail. Must be 30s lower than `valid_lifetime`. Defaults to 51m (3060s).
        """
        return pulumi.get(self, "rebind_timer")
    ...
    @property
    @pulumi.getter(name="renewTimer")
    def renew_timer(self) -> pulumi.Output[builtins.int]:
        """
        After how long, in seconds, a renewal will be attempted. Must be 30s lower than `rebind_timer`. Defaults to 50m (3000s).
        """
        return pulumi.get(self, "renew_timer")
    ...
    @property
    @pulumi.getter(name="validLifetime")
    def valid_lifetime(self) -> pulumi.Output[builtins.int]:
        """
        How long, in seconds, DHCP entries will be valid. Defaults to 1h (3600s).
        """
        return pulumi.get(self, "valid_lifetime")
