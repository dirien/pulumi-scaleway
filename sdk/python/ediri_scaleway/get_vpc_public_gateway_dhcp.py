...
class GetVpcPublicGatewayDhcpResult:
    ...
    def pool_high(self) -> builtins.str:
        return pulumi.get(self, "pool_high")

    @property
    @pulumi.getter(name="poolLow")
    def pool_low(self) -> builtins.str:
    ...
    def valid_lifetime(self) -> builtins.int:
...
def get_vpc_public_gateway_dhcp(dhcp_id: Optional[builtins.str] = None,
                                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetVpcPublicGatewayDhcpResult:
    """
    > **Important:**  The data source `VpcPublicGatewayDhcp` has been deprecated and will no longer be supported.
...
def get_vpc_public_gateway_dhcp_output(dhcp_id: Optional[pulumi.Input[builtins.str]] = None,
