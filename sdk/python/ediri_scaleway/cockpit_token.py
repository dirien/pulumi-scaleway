...
class CockpitTokenArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] region: ) The region where the Cockpit token is located.
...
class _CockpitTokenState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] created_at: The date and time of the creation of the Cockpit Token (Format ISO 8601)
        :param pulumi.Input[builtins.str] name: The name of the token.
        :param pulumi.Input[builtins.str] project_id: ) The ID of the Project the Cockpit is associated with.
        :param pulumi.Input[builtins.str] region: ) The region where the Cockpit token is located.
        :param pulumi.Input['CockpitTokenScopesArgs'] scopes: Scopes allowed, each with default values:
        :param pulumi.Input[builtins.str] secret_key: The secret key of the token.
        :param pulumi.Input[builtins.str] updated_at: The date and time of the last update of the Cockpit Token (Format ISO 8601)
        """
...
@pulumi.type_token("scaleway:index/cockpitToken:CockpitToken")
class CockpitToken(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            scopes: Optional[pulumi.Input[Union['CockpitTokenScopesArgs', 'CockpitTokenScopesArgsDict']]] = None,
            secret_key: Optional[pulumi.Input[builtins.str]] = None,
            updated_at: Optional[pulumi.Input[builtins.str]] = None) -> 'CockpitToken':
        """
