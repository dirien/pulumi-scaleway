...
class InstanceUserDataArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] key: Key of the user data.
        :param pulumi.Input[builtins.str] server_id: The ID of the server associated with.
        :param pulumi.Input[builtins.str] value: Value associated with your key
...
@pulumi.type_token("scaleway:index/instanceUserData:InstanceUserData")
class InstanceUserData(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            server_id: Optional[pulumi.Input[builtins.str]] = None,
            value: Optional[pulumi.Input[builtins.str]] = None,
            zone: Optional[pulumi.Input[builtins.str]] = None) -> 'InstanceUserData':
        """
