...
class RdbReadReplicaArgs:
    def __init__(__self__, *,
                 ...
                 same_zone: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a RdbReadReplica resource.
        :param pulumi.Input[builtins.str] instance_id: UUID of the rdb instance.
        ...
        :param pulumi.Input[builtins.bool] same_zone: Defines whether to create the replica in the same availability zone as the main instance nodes or not.
        """
    ...
    def same_zone(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @same_zone.setter
    def same_zone(self, value: Optional[pulumi.Input[builtins.bool]]):
...
@pulumi.type_token("scaleway:index/rdbReadReplica:RdbReadReplica")
class RdbReadReplica(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 direct_access: Optional[pulumi.Input[Union['RdbReadReplicaDirectAccessArgs', 'RdbReadReplicaDirectAccessArgsDict']]] = None,
                 instance_id: Optional[pulumi.Input[builtins.str]] = None,
                 private_network: Optional[pulumi.Input[Union['RdbReadReplicaPrivateNetworkArgs', 'RdbReadReplicaPrivateNetworkArgsDict']]] = None,
                 region: Optional[pulumi.Input[builtins.str]] = None,
                 same_zone: Optional[pulumi.Input[builtins.bool]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Union['RdbReadReplicaDirectAccessArgs', 'RdbReadReplicaDirectAccessArgsDict']] direct_access: Creates a direct access endpoint to rdb replica.
        :param pulumi.Input[builtins.str] instance_id: UUID of the rdb instance.
               
               > **Important:** The replica musts contains at least one `direct_access` or `private_network`. It can contain both.
        :param pulumi.Input[Union['RdbReadReplicaPrivateNetworkArgs', 'RdbReadReplicaPrivateNetworkArgsDict']] private_network: Create an endpoint in a Private Netork.
        :param pulumi.Input[builtins.str] region: `region`) The region
               in which the Read Replica should be created.
        :param pulumi.Input[builtins.bool] same_zone: Defines whether to create the replica in the same availability zone as the main instance nodes or not.
        """
    ...
    def get(resource_name: str,
            ...
            private_network: Optional[pulumi.Input[Union['RdbReadReplicaPrivateNetworkArgs', 'RdbReadReplicaPrivateNetworkArgsDict']]] = None,
            region: Optional[pulumi.Input[builtins.str]] = None,
            same_zone: Optional[pulumi.Input[builtins.bool]] = None) -> 'RdbReadReplica':
        """
    ...
    @property
    @pulumi.getter(name="sameZone")
    def same_zone(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Defines whether to create the replica in the same availability zone as the main instance nodes or not.
        """
        return pulumi.get(self, "same_zone")
