...
__all__ = [
    'GetBaremetalPartitionSchemaResult',
    'AwaitableGetBaremetalPartitionSchemaResult',
    'get_baremetal_partition_schema',
    'get_baremetal_partition_schema_output',
]

@pulumi.output_type
class GetBaremetalPartitionSchemaResult:
    """
...
class AwaitableGetBaremetalPartitionSchemaResult(GetBaremetalPartitionSchemaResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetBaremetalPartitionSchemaResult(
...
def get_baremetal_partition_schema(ext4_mountpoint: Optional[builtins.str] = None,
                                   ...
                                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetBaremetalPartitionSchemaResult:
    """
    The get_baremetal_partition_schema data source allows you to retrieve a ready-to-use partitioning schema for a BareMetal server. This schema can be used for custom installations with optional swap and extra partitions.
    ...
    The partitioning schema generated by the `get_baremetal_partition_schema` data source includes a root (`/`) partition that is **20GB** in size by default.
    ...
    default = scaleway.get_baremetal_partition_schema(ext4_mountpoint="/data",
    ...
    __ret__ = pulumi.runtime.invoke('scaleway:index/getBaremetalPartitionSchema:getBaremetalPartitionSchema', __args__, opts=opts, typ=GetBaremetalPartitionSchemaResult).value

    return AwaitableGetBaremetalPartitionSchemaResult(
...
def get_baremetal_partition_schema_output(ext4_mountpoint: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                          ...
                                          opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetBaremetalPartitionSchemaResult]:
    """
    The get_baremetal_partition_schema data source allows you to retrieve a ready-to-use partitioning schema for a BareMetal server. This schema can be used for custom installations with optional swap and extra partitions.
    ...
    __ret__ = pulumi.runtime.invoke_output('scaleway:index/getBaremetalPartitionSchema:getBaremetalPartitionSchema', __args__, opts=opts, typ=GetBaremetalPartitionSchemaResult)
    return __ret__.apply(lambda __response__: GetBaremetalPartitionSchemaResult(
