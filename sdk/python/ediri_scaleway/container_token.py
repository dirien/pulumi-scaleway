...
class ContainerTokenArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] container_id: The unique identifier of the container.
        ...
        :param pulumi.Input[builtins.str] expires_at: The expiration date of the token.
        :param pulumi.Input[builtins.str] namespace_id: The unique identifier of the Containers namespace.
...
class _ContainerTokenState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] region: `region`). The region in which the namespace is created.
               ...
               > **Important** Updating any of the arguments above will recreate the token.
        :param pulumi.Input[builtins.str] token: The token.
        """
        if container_id is not None:
            pulumi.set(__self__, "container_id", container_id)
        if description is not None:
...
@pulumi.type_token("scaleway:index/containerToken:ContainerToken")
class ContainerToken(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            namespace_id: Optional[pulumi.Input[builtins.str]] = None,
            region: Optional[pulumi.Input[builtins.str]] = None,
            token: Optional[pulumi.Input[builtins.str]] = None) -> 'ContainerToken':
        """
