...
class InstanceIpArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] type: The type of the IP (`routed_ipv4`, `routed_ipv6`), more information in [the documentation](https://www.scaleway.com/en/docs/compute/instances/api-cli/using-routed-ips/)
...
class _InstanceIpState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] organization_id: The organization ID the IP is associated with.
        :param pulumi.Input[builtins.str] prefix: The IP Prefix.
        :param pulumi.Input[builtins.str] project_id: `project_id`) The ID of the project the IP is associated with.
        :param pulumi.Input[builtins.str] reverse: The reverse dns attached to this IP
        :param pulumi.Input[builtins.str] server_id: The server associated with this IP
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: The tags associated with the IP.
        :param pulumi.Input[builtins.str] type: The type of the IP (`routed_ipv4`, `routed_ipv6`), more information in [the documentation](https://www.scaleway.com/en/docs/compute/instances/api-cli/using-routed-ips/)
        :param pulumi.Input[builtins.str] zone: `zone`) The zone in which the IP should be reserved.
        """
...
class InstanceIp(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None,
            zone: Optional[pulumi.Input[builtins.str]] = None) -> 'InstanceIp':
        """
