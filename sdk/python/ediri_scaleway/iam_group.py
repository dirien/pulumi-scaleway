...
class IamGroupArgs:
    def __init__(__self__, *,
                 ...
                 external_membership: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] application_ids: The list of IDs of the applications attached to the group.
        :param pulumi.Input[builtins.str] description: The description of the IAM group.
        :param pulumi.Input[builtins.bool] external_membership: Manage membership externally. This make the resource ignore user_ids and application_ids. Should be used when using iam_group_membership
        :param pulumi.Input[builtins.str] name: The name of the IAM group.
        :param pulumi.Input[builtins.str] organization_id: `organization_id`) The ID of the organization the group is associated with.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: The tags associated with the group.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] user_ids: The list of IDs of the users attached to the group.
        """
    ...
    def external_membership(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def external_membership(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _IamGroupState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] application_ids: The list of IDs of the applications attached to the group.
        :param pulumi.Input[builtins.str] created_at: The date and time of the creation of the group
        :param pulumi.Input[builtins.str] description: The description of the IAM group.
        :param pulumi.Input[builtins.bool] external_membership: Manage membership externally. This make the resource ignore user_ids and application_ids. Should be used when using iam_group_membership
        :param pulumi.Input[builtins.str] name: The name of the IAM group.
        :param pulumi.Input[builtins.str] organization_id: `organization_id`) The ID of the organization the group is associated with.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: The tags associated with the group.
        :param pulumi.Input[builtins.str] updated_at: The date and time of the last update of the group
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] user_ids: The list of IDs of the users attached to the group.
        """
        if application_ids is not None:
            pulumi.set(__self__, "application_ids", application_ids)
...
class IamGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            updated_at: Optional[pulumi.Input[builtins.str]] = None,
            user_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'IamGroup':
        """
    ...
    @property
    @pulumi.getter(name="applicationIds")
    def application_ids(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The list of IDs of the applications attached to the group.
        """
        return pulumi.get(self, "application_ids")
    ...
    @property
    @pulumi.getter(name="externalMembership")
    def external_membership(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Manage membership externally. This make the resource ignore user_ids and application_ids. Should be used when using iam_group_membership
        """
        return pulumi.get(self, "external_membership")
