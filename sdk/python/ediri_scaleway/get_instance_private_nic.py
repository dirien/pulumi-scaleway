...
class GetInstancePrivateNicResult:
    ...
    def private_nic_id(self) -> Optional[builtins.str]:
...
def get_instance_private_nic(private_network_id: Optional[builtins.str] = None,
                             private_nic_id: Optional[builtins.str] = None,
    ...
    :param builtins.str private_network_id: The ID of the private network
           Only one of `private_nic_id` and `private_network_id` should be specified.
    :param builtins.str private_nic_id: The ID of the instance server private nic
           Only one of `private_nic_id` and `private_network_id` should be specified.
    :param builtins.str server_id: The server's id
    :param Sequence[builtins.str] tags: The tags associated with the private NIC.
           As datasource only returns one private NIC, the search with given tags must return only one result
    :param builtins.str zone: `zone`) The zone in which the private nic exists.
    """
    __args__ = dict()
...
def get_instance_private_nic_output(private_network_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                    private_nic_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
