...
class GetBaremetalOptionResult:
    ...
    @property
    @pulumi.getter
    def manageable(self) -> builtins.bool:
        """
    ...
    def option_id(self) -> Optional[builtins.str]:
...
def get_baremetal_option(name: Optional[builtins.str] = None,
                         option_id: Optional[builtins.str] = None,
    ...
    :param builtins.str name: The option name. Only one of `name` and `option_id` should be specified.
    :param builtins.str option_id: The option id. Only one of `name` and `option_id` should be specified.
    :param builtins.str zone: `zone`) The zone in which the option exists.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_baremetal_option_output(name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                option_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
