...
class WebhostingArgs:
    def __init__(__self__, *,
                 ...
                 option_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 project_id: Optional[pulumi.Input[builtins.str]] = None,
                 region: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a Webhosting resource.
        :param pulumi.Input[builtins.str] domain: The domain name of the hosting.
        :param pulumi.Input[builtins.str] email: The contact email of the client for the hosting.
        :param pulumi.Input[builtins.str] offer_id: The ID of the selected offer for the hosting.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] option_ids: The IDs of the selected options for the hosting.
        :param pulumi.Input[builtins.str] project_id: `project_id`) The ID of the project the VPC is associated with.
        :param pulumi.Input[builtins.str] region: `region`) The region of the Hosting.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: The tags associated with the hosting.
        """
    ...
    def option_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @option_ids.setter
    def option_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _WebhostingState:
    def __init__(__self__, *,
                 ...
                 dns_status: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 platform_hostname: Optional[pulumi.Input[builtins.str]] = None,
                 platform_number: Optional[pulumi.Input[builtins.int]] = None,
                 project_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] created_at: Date and time of hosting's creation (RFC 3339 format).
        :param pulumi.Input[builtins.str] dns_status: The DNS status of the hosting.
        :param pulumi.Input[builtins.str] domain: The domain name of the hosting.
        :param pulumi.Input[builtins.str] email: The contact email of the client for the hosting.
        ...
        :param pulumi.Input[builtins.str] offer_id: The ID of the selected offer for the hosting.
        :param pulumi.Input[builtins.str] offer_name: The name of the active offer.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] option_ids: The IDs of the selected options for the hosting.
        :param pulumi.Input[Sequence[pulumi.Input['WebhostingOptionArgs']]] options: The active options of the hosting.
        :param pulumi.Input[builtins.str] organization_id: (Deprecated) The organization ID the hosting is associated with.
        :param pulumi.Input[builtins.str] platform_hostname: The hostname of the host platform.
        :param pulumi.Input[builtins.int] platform_number: The number of the host platform.
        :param pulumi.Input[builtins.str] project_id: `project_id`) The ID of the project the VPC is associated with.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: The tags associated with the hosting.
        :param pulumi.Input[builtins.str] updated_at: Date and time of hosting's last update (RFC 3339 format).
        :param pulumi.Input[builtins.str] username: The main hosting cPanel username.
        """
    ...
    def dns_status(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @dns_status.setter
    def dns_status(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def platform_hostname(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def platform_hostname(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "platform_hostname", value)

    @property
    @pulumi.getter(name="platformNumber")
    def platform_number(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def platform_number(self, value: Optional[pulumi.Input[builtins.int]]):
...
class Webhosting(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            updated_at: Optional[pulumi.Input[builtins.str]] = None,
            username: Optional[pulumi.Input[builtins.str]] = None) -> 'Webhosting':
        """
    ...
    @property
    @pulumi.getter(name="dnsStatus")
    def dns_status(self) -> pulumi.Output[builtins.str]:
        """
        The DNS status of the hosting.
        """
        return pulumi.get(self, "dns_status")
    ...
    @property
    @pulumi.getter(name="optionIds")
    def option_ids(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The IDs of the selected options for the hosting.
        """
        return pulumi.get(self, "option_ids")
    ...
    @property
    @pulumi.getter(name="platformHostname")
    def platform_hostname(self) -> pulumi.Output[builtins.str]:
        """
        The hostname of the host platform.
        """
        return pulumi.get(self, "platform_hostname")
    ...
    @property
    @pulumi.getter(name="platformNumber")
    def platform_number(self) -> pulumi.Output[builtins.int]:
        """
        The number of the host platform.
        """
        return pulumi.get(self, "platform_number")
