...
class ObjectItemArgs:
    def __init__(__self__, *,
                 ...
                 sse_customer_key: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] key: The path to the object.
        :param pulumi.Input[builtins.str] content: The content of the file to upload. Only one of `file`, `content` or `content_base64` can be defined.
        :param pulumi.Input[builtins.str] content_base64: The base64-encoded content of the file to upload. Only one of `file`, `content` or `content_base64` can be defined.
               
               > **Note:** Only one of `file`, `content` or `content_base64` can be defined.
        :param pulumi.Input[builtins.str] content_type: The standard MIME type of the object's content (e.g., 'application/json', 'text/plain'). This specifies how the object should be interpreted by clients. See RFC 9110: https://www.rfc-editor.org/rfc/rfc9110.html#name-content-type
        :param pulumi.Input[builtins.str] file: The name of the file to upload, defaults to an empty file.
        :param pulumi.Input[builtins.str] hash: Hash of the file, used to trigger the upload on file change.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] metadata: Map of metadata used for the object (keys must be lowercase).
        :param pulumi.Input[builtins.str] project_id: The project_id you want to attach the resource to
        :param pulumi.Input[builtins.str] region: The Scaleway region the bucket resides in.
        :param pulumi.Input[builtins.str] sse_customer_key: Customer's encryption keys to encrypt data (SSE-C)
        :param pulumi.Input[builtins.str] storage_class: Specifies the Scaleway [storage class](https://www.scaleway.com/en/docs/object-storage/concepts/#storage-class) (`STANDARD`, `GLACIER`, or `ONEZONE_IA`) used to store the object.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Map of tags.
        :param pulumi.Input[builtins.str] visibility: Visibility of the object, `public-read` or `private`.
        """
    ...
    def sse_customer_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def sse_customer_key(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ObjectItem(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            storage_class: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            visibility: Optional[pulumi.Input[builtins.str]] = None) -> 'ObjectItem':
        """
    ...
    @property
    @pulumi.getter(name="sseCustomerKey")
    def sse_customer_key(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Customer's encryption keys to encrypt data (SSE-C)
        """
        return pulumi.get(self, "sse_customer_key")
