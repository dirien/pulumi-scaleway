...
class BaremetalServer(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        my_offer = scaleway.get_baremetal_offer(zone="fr-par-2",
            name="EM-B112X-SSD")
        my_server = scaleway.BaremetalServer("myServer",
            zone="fr-par-2",
        ...
        my_ssh_key = scaleway.IamSshKey("mySshKey", public_key="ssh XXXXXXXXXXX")
        ...
        You cannot directly modify the subscription_period of an existing get_baremetal_offer resource. Instead, you must define the monthly offer using the data source and then update the server configuration accordingly.
