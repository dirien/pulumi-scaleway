...
__all__ = [
    'GetInferenceModelResult',
    'AwaitableGetInferenceModelResult',
    'get_inference_model',
    'get_inference_model_output',
]

@pulumi.output_type
class GetInferenceModelResult:
    """
    ...
    def nodes_supports(self) -> Sequence['outputs.GetInferenceModelNodesSupportResult']:
        """
...
class AwaitableGetInferenceModelResult(GetInferenceModelResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetInferenceModelResult(
...
def get_inference_model(model_id: Optional[builtins.str] = None,
                        name: Optional[builtins.str] = None,
                        url: Optional[builtins.str] = None,
                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetInferenceModelResult:
    """
    The `InferenceModel` data source allows you to retrieve information about an inference model available in the Scaleway Inference API, either by providing the model's `name` or its `model_id`.
    ...
    my_model = scaleway.get_inference_model(name="meta/llama-3.1-8b-instruct:fp8")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('scaleway:index/getInferenceModel:getInferenceModel', __args__, opts=opts, typ=GetInferenceModelResult).value

    return AwaitableGetInferenceModelResult(
...
def get_inference_model_output(model_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                               name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                               url: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                               opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetInferenceModelResult]:
    """
    The `InferenceModel` data source allows you to retrieve information about an inference model available in the Scaleway Inference API, either by providing the model's `name` or its `model_id`.
    ...
    __ret__ = pulumi.runtime.invoke_output('scaleway:index/getInferenceModel:getInferenceModel', __args__, opts=opts, typ=GetInferenceModelResult)
    return __ret__.apply(lambda __response__: GetInferenceModelResult(
