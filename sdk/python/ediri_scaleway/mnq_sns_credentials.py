...
class MnqSnsCredentialsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: The unique name of the SNS credentials.
        ...
        :param pulumi.Input[builtins.str] region: `region`). The region in which SNS is enabled.
        """
        if name is not None:
...
@pulumi.type_token("scaleway:index/mnqSnsCredentials:MnqSnsCredentials")
class MnqSnsCredentials(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            project_id: Optional[pulumi.Input[builtins.str]] = None,
            region: Optional[pulumi.Input[builtins.str]] = None,
            secret_key: Optional[pulumi.Input[builtins.str]] = None) -> 'MnqSnsCredentials':
        """
