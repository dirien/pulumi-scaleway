...
class GetConfigResult:
    ...
    def access_key_source(self) -> builtins.str:
    ...
    def project_id_source(self) -> builtins.str:
    ...
    def region_source(self) -> builtins.str:
    ...
    def secret_key_source(self) -> builtins.str:
    ...
    def zone_source(self) -> builtins.str:
