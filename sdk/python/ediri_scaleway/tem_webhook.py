...
class TemWebhook(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        sns_credentials = scaleway.MnqSnsCredentials("snsCredentials", permissions={
            "can_manage": True,
        })
        sns_topic = scaleway.MnqSnsTopic("snsTopic",
            access_key=sns_credentials.access_key,
            secret_key=sns_credentials.secret_key)
        cr01 = scaleway.TemDomain("cr01", accept_tos=True)
    ...
    def get(resource_name: str,
            ...
            region: Optional[pulumi.Input[builtins.str]] = None,
            sns_arn: Optional[pulumi.Input[builtins.str]] = None,
            updated_at: Optional[pulumi.Input[builtins.str]] = None) -> 'TemWebhook':
        """
