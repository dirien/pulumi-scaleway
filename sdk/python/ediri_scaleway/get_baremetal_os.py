...
class GetBaremetalOsResult:
    ...
    def os_id(self) -> Optional[builtins.str]:
...
def get_baremetal_os(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: The os name. Only one of `name` and `os_id` should be specified.
    :param builtins.str os_id: The operating system id. Only one of `name` and `os_id` should be specified.
    :param builtins.str version: The os version.
    :param builtins.str zone: `zone`) The zone in which the os exists.
    """
    __args__ = dict()
    __args__['name'] = name
    __args__['osId'] = os_id
...
def get_baremetal_os_output(name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                            os_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
