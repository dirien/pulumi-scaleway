...
class JobDefinitionArgs:
    def __init__(__self__, *,
                 cpu_limit: pulumi.Input[builtins.int],
                 memory_limit: pulumi.Input[builtins.int],
        ...
        :param pulumi.Input[builtins.int] cpu_limit: The amount of vCPU computing resources to allocate to each container running the job.
        :param pulumi.Input[builtins.int] memory_limit: The memory computing resources in MB to allocate to each container running the job.
        :param pulumi.Input[builtins.str] command: The command that will be run in the container if specified.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] env: The environment variables of the container.
        :param pulumi.Input[builtins.str] image_uri: The uri of the container image that will be used for the job run.
        :param pulumi.Input[builtins.str] name: The name of the job.
        :param pulumi.Input[builtins.str] project_id: `project_id`) The ID of the project the Job is associated with.
        :param pulumi.Input[builtins.str] region: `region`) The region of the Job.
        ...
        :param pulumi.Input[builtins.str] timeout: The job run timeout, in Go Time format (ex: `2h30m25s`)
        """
    ...
    def cpu_limit(self) -> pulumi.Input[builtins.int]:
        """
    ...
    @cpu_limit.setter
    def cpu_limit(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "cpu_limit", value)

    @property
    @pulumi.getter(name="memoryLimit")
    def memory_limit(self) -> pulumi.Input[builtins.int]:
        """
    ...
    @memory_limit.setter
    def memory_limit(self, value: pulumi.Input[builtins.int]):
...
class JobDefinition(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            region: Optional[pulumi.Input[builtins.str]] = None,
            secret_references: Optional[pulumi.Input[Sequence[pulumi.Input[Union['JobDefinitionSecretReferenceArgs', 'JobDefinitionSecretReferenceArgsDict']]]]] = None,
            timeout: Optional[pulumi.Input[builtins.str]] = None) -> 'JobDefinition':
        """
