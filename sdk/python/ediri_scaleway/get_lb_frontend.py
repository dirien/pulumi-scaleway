...
class GetLbFrontendResult:
    ...
    def external_acls(self) -> builtins.bool:
...
def get_lb_frontend(frontend_id: Optional[builtins.str] = None,
    ...
    :param builtins.str frontend_id: The frontend ID.
           - Only one of `name` and `frontend_id` should be specified.
    :param builtins.str lb_id: The Load Balancer ID this frontend is attached to.
