...
class RdbSnapshotArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] instance_id: The UUID of the database instance for which the snapshot is created.
        :param pulumi.Input[builtins.str] expires_at: Expiration date of the snapshot in ISO 8601 format (e.g., `2025-01-31T00:00:00Z`). If not set, the snapshot will not expire automatically.
        :param pulumi.Input[builtins.str] name: The name of the snapshot.
        :param pulumi.Input[builtins.str] region: The region where the snapshot is stored. Defaults to the region set in the provider configuration.
        """
...
class _RdbSnapshotState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] created_at: The timestamp when the snapshot was created, in ISO 8601 format.
        :param pulumi.Input[builtins.str] expires_at: Expiration date of the snapshot in ISO 8601 format (e.g., `2025-01-31T00:00:00Z`). If not set, the snapshot will not expire automatically.
        :param pulumi.Input[builtins.str] instance_id: The UUID of the database instance for which the snapshot is created.
        :param pulumi.Input[builtins.str] name: The name of the snapshot.
        :param pulumi.Input[builtins.str] node_type: The type of the database instance for which the snapshot was created.
        :param pulumi.Input[builtins.str] region: The region where the snapshot is stored. Defaults to the region set in the provider configuration.
        :param pulumi.Input[builtins.int] size: The size of the snapshot in bytes.
        :param pulumi.Input[builtins.str] status: The current status of the snapshot (e.g., `ready`, `creating`, `error`).
        :param pulumi.Input[builtins.str] updated_at: The timestamp when the snapshot was last updated, in ISO 8601 format.
        :param pulumi.Input[builtins.str] volume_type: The type of volume used by the snapshot.
        """
...
class RdbSnapshot(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test = scaleway.RdbSnapshot("test", instance_id=main.id,
        ...
        snapshot_with_expiration = scaleway.RdbSnapshot("snapshotWithExpiration",
        ...
        snapshot_a = scaleway.RdbSnapshot("snapshotA", instance_id=scaleway_rdb_instance["main"]["id"],
        opts = pulumi.ResourceOptions(depends_on=[scaleway_rdb_instance["main"]]))
        snapshot_b = scaleway.RdbSnapshot("snapshotB",
            instance_id=scaleway_rdb_instance["main"]["id"],
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            updated_at: Optional[pulumi.Input[builtins.str]] = None,
            volume_type: Optional[pulumi.Input[builtins.str]] = None) -> 'RdbSnapshot':
        """
