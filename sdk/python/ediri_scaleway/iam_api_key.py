...
class IamApiKeyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] application_id: ID of the application attached to the API key.
        :param pulumi.Input[builtins.str] default_project_id: The default Project ID to use with Object Storage.
        :param pulumi.Input[builtins.str] description: The description of the API key.
        :param pulumi.Input[builtins.str] expires_at: The date and time of the expiration of the IAM API key. Please note that in case of any changes,
               the resource will be recreated.
        :param pulumi.Input[builtins.str] user_id: ID of the user attached to the API key.
...
class _IamApiKeyState:
    def __init__(__self__, *,
                 ...
                 creation_ip: Optional[pulumi.Input[builtins.str]] = None,
                 default_project_id: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] access_key: The access key of the IAM API key.
        :param pulumi.Input[builtins.str] application_id: ID of the application attached to the API key.
        :param pulumi.Input[builtins.str] created_at: The date and time of the creation of the IAM API key.
        :param pulumi.Input[builtins.str] creation_ip: The IP Address of the device which created the API key.
        :param pulumi.Input[builtins.str] default_project_id: The default Project ID to use with Object Storage.
        :param pulumi.Input[builtins.str] description: The description of the API key.
        :param pulumi.Input[builtins.bool] editable: Whether the IAM API key is editable.
        :param pulumi.Input[builtins.str] expires_at: The date and time of the expiration of the IAM API key. Please note that in case of any changes,
               the resource will be recreated.
        :param pulumi.Input[builtins.str] secret_key: The secret Key of the IAM API key.
        :param pulumi.Input[builtins.str] updated_at: The date and time of the last update of the IAM API key.
        :param pulumi.Input[builtins.str] user_id: ID of the user attached to the API key.
               > **Note** You must specify at least one: `application_id` and/or `user_id`.
        """
    ...
    def creation_ip(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @creation_ip.setter
    def creation_ip(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("scaleway:index/iamApiKey:IamApiKey")
class IamApiKey(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            secret_key: Optional[pulumi.Input[builtins.str]] = None,
            updated_at: Optional[pulumi.Input[builtins.str]] = None,
            user_id: Optional[pulumi.Input[builtins.str]] = None) -> 'IamApiKey':
        """
    ...
    @property
    @pulumi.getter(name="creationIp")
    def creation_ip(self) -> pulumi.Output[builtins.str]:
        """
        The IP Address of the device which created the API key.
        """
        return pulumi.get(self, "creation_ip")
