...
class GetInstanceSecurityGroupResult:
    ...
    def enable_default_security(self) -> builtins.bool:
        return pulumi.get(self, "enable_default_security")

    @property
    @pulumi.getter(name="externalRules")
    def external_rules(self) -> builtins.bool:
    ...
    def inbound_default_policy(self) -> builtins.str:
        """
    ...
    def outbound_default_policy(self) -> builtins.str:
        """
...
def get_instance_security_group(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: The security group name. Only one of `name` and `security_group_id` should be specified.
    :param builtins.str project_id: The ID of the project the security group is associated with.
    :param builtins.str security_group_id: The security group id. Only one of `name` and `security_group_id` should be specified.
    :param builtins.str zone: `zone`) The zone in which the security group exists.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_instance_security_group_output(name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
