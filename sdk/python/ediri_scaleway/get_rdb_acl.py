...
def get_rdb_acl(instance_id: Optional[builtins.str] = None,
    ...
    :param builtins.str region: `region`) The region in which the Database Instance should be created.
    """
    __args__ = dict()
...
def get_rdb_acl_output(instance_id: Optional[pulumi.Input[builtins.str]] = None,
                       region: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                       opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetRdbAclResult]:
    """
    Gets information about the Database Instance network Access Control List.
