...
__all__ = [
    'GetRdbInstanceResult',
    'AwaitableGetRdbInstanceResult',
    'get_rdb_instance',
    'get_rdb_instance_output',
]

@pulumi.output_type
class GetRdbInstanceResult:
    """
    ...
    def load_balancers(self) -> Sequence['outputs.GetRdbInstanceLoadBalancerResult']:
        return pulumi.get(self, "load_balancers")

    @property
    @pulumi.getter(name="logsPolicies")
    def logs_policies(self) -> Sequence['outputs.GetRdbInstanceLogsPolicyResult']:
    ...
    def private_ips(self) -> Sequence['outputs.GetRdbInstancePrivateIpResult']:
        return pulumi.get(self, "private_ips")

    @property
    @pulumi.getter(name="privateNetworks")
    def private_networks(self) -> Sequence['outputs.GetRdbInstancePrivateNetworkResult']:
    ...
    def read_replicas(self) -> Sequence['outputs.GetRdbInstanceReadReplicaResult']:
...
class AwaitableGetRdbInstanceResult(GetRdbInstanceResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetRdbInstanceResult(
...
def get_rdb_instance(instance_id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('scaleway:index/getRdbInstance:getRdbInstance', __args__, opts=opts, typ=GetRdbInstanceResult).value

    return AwaitableGetRdbInstanceResult(
...
def get_rdb_instance_output(instance_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                            name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                            project_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                            region: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                            opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetRdbInstanceResult]:
    """
    Gets information about an Database Instance.
    ...
    __ret__ = pulumi.runtime.invoke_output('scaleway:index/getRdbInstance:getRdbInstance', __args__, opts=opts, typ=GetRdbInstanceResult)
    return __ret__.apply(lambda __response__: GetRdbInstanceResult(
