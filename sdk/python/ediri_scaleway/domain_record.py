...
class DomainRecordArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] ttl: Time To Live of the record in seconds.
...
class _DomainRecordState:
    def __init__(__self__, *,
                 ...
                 priority: Optional[pulumi.Input[builtins.int]] = None,
                 project_id: Optional[pulumi.Input[builtins.str]] = None,
                 root_zone: Optional[pulumi.Input[builtins.bool]] = None,
                 ttl: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.int] priority: The priority of the record (mostly used with an `MX` record).
        :param pulumi.Input[builtins.str] project_id: The project_id you want to attach the resource to
        :param pulumi.Input[builtins.bool] root_zone: Does the DNS zone is the root zone or not
        :param pulumi.Input[builtins.int] ttl: Time To Live of the record in seconds.
        :param pulumi.Input[builtins.str] type: The type of the record (`A`, `AAAA`, `MX`, `CNAME`, `DNAME`, `ALIAS`, `NS`, `PTR`, `SRV`, `TXT`, `TLSA`, or `CAA`).
        :param pulumi.Input[Sequence[pulumi.Input['DomainRecordViewArgs']]] views: Return record based on client subnet
        :param pulumi.Input[Sequence[pulumi.Input['DomainRecordWeightedArgs']]] weighteds: Return record based on weight
    ...
    def root_zone(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @root_zone.setter
    def root_zone(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class DomainRecord(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="rootZone")
    def root_zone(self) -> pulumi.Output[builtins.bool]:
        """
        Does the DNS zone is the root zone or not
        """
        return pulumi.get(self, "root_zone")
