 ...
 *
 * const mainObjectBucket = new scaleway.ObjectBucket("mainObjectBucket", {tags: {
 *     foo: "bar",
 * }});
 * const mainEdgeServicesPipeline = new scaleway.EdgeServicesPipeline("mainEdgeServicesPipeline", {});
 ...
 *     ipIds: [scaleway_lb_ip.main.id],
 *     zone: "fr-par-1",
 *     type: "LB-S",
 * });
 * const mainLbFrontend = new scaleway.LbFrontend("mainLbFrontend", {
 *     lbId: mainLb.id,
 *     backendId: scaleway_lb_backend.main.id,
 *     inboundPort: 443,
 *     certificateIds: [scaleway_lb_certificate.cert01.id],
 * });
 * const mainEdgeServicesPipeline = new scaleway.EdgeServicesPipeline("mainEdgeServicesPipeline", {});
 * const mainEdgeServicesBackendStage = new scaleway.EdgeServicesBackendStage("mainEdgeServicesBackendStage", {
 *     pipelineId: mainEdgeServicesPipeline.id,
 ...
 *         lbConfig: {
 *             id: mainLb.id,
 *             frontendId: scaleway_lb_frontend.id,
 *             isSsl: true,
 *             zone: "fr-par-1",
 *         },
 *     }],
