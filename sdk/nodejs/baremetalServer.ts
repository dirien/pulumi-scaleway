 ...
 *     name: "EM-B112X-SSD",
 * });
 * const myServer = new scaleway.BaremetalServer("myServer", {
 *     zone: "fr-par-2",
 ...
 * });
 * const mySshKey = new scaleway.IamSshKey("mySshKey", {publicKey: "ssh XXXXXXXXXXX"});
 * const myOffer = scaleway.getBaremetalOffer({
 *     zone: "fr-par-1",
 *     name: "EM-B220E-NVME",
 ...
 * You cannot directly modify the subscriptionPeriod of an existing scaleway.getBaremetalOffer resource. Instead, you must define the monthly offer using the data source and then update the server configuration accordingly.
 *
 * ### Hourly Plan Example
 *
 * ```typescript
