...
export class InstanceSnapshot extends pulumi.CustomResource {
     ...
     *
     * > **Important:** Snapshots of volumes with type `bSsd` (Block SSD) are deprecated and cannot be managed using the `scaleway.InstanceSnapshot` resource anymore. Please use the `scaleway.BlockSnapshot` resource instead.
