 ...
 *
 * const test = scaleway.getTemOfferSubscription({});
 * ```
 */
export function getTemOfferSubscription(args?: GetTemOfferSubscriptionArgs, opts?: pulumi.InvokeOptions): Promise<GetTemOfferSubscriptionResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("scaleway:index/getTemOfferSubscription:getTemOfferSubscription", {
 ...
 */
export interface GetTemOfferSubscriptionArgs {
    /**
 ...
 */
export interface GetTemOfferSubscriptionResult {
    /**
 ...
 * ```
 */
export function getTemOfferSubscriptionOutput(args?: GetTemOfferSubscriptionOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetTemOfferSubscriptionResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("scaleway:index/getTemOfferSubscription:getTemOfferSubscription", {
        "projectId": args.projectId,
        "region": args.region,
    }, opts);
}
 ...
 * A collection of arguments for invoking getTemOfferSubscription.
 */
export interface GetTemOfferSubscriptionOutputArgs {
    /**
     * `projectId`) The ID of the project the offer subscription is associated with.
     */
