 ...
 *
 * const test = new scaleway.InferenceModel("test", {
 ...
 * import * as scaleway from "@ediri/scaleway";
 *
 * const myModel = new scaleway.InferenceModel("myModel", {
 *     url: "https://huggingface.co/agentica-org/DeepCoder-14B-Preview",
 *     secret: "my-secret-token",
 * });
 * const myDeployment = new scaleway.InferenceDeployment("myDeployment", {
 *     nodeType: "H100",
 *     modelId: myModel.id,
 *     publicEndpoint: {
 *         isEnabled: true,
 ...
 * ```
 */
export class InferenceModel extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: InferenceModelState, opts?: pulumi.CustomResourceOptions): InferenceModel {
        return new InferenceModel(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'scaleway:index/inferenceModel:InferenceModel';

    /**
     * Returns true if the given object is an instance of InferenceModel.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is InferenceModel {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === InferenceModel.__pulumiType;
    }
     ...
     */
    public /*out*/ readonly nodesSupports!: pulumi.Output<outputs.InferenceModelNodesSupport[]>;
    /**
     ...
     */
    constructor(name: string, args: InferenceModelArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: InferenceModelArgs | InferenceModelState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as InferenceModelState | undefined;
            ...
            const args = argsOrState as InferenceModelArgs | undefined;
        ...
        super(InferenceModel.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface InferenceModelState {
     ...
     * List of supported node types and their quantization options. Each entry contains:
     */
    nodesSupports?: pulumi.Input<pulumi.Input<inputs.InferenceModelNodesSupport>[]>;
    /**
     * Size, in bits, of the model parameters.
     */
