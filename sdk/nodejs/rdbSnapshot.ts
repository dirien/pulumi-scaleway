 ...
 *     volumeSizeInGb: 10,
 * });
 * const test = new scaleway.RdbSnapshot("test", {instanceId: main.id}, {
 *     dependsOn: [main],
 * });
 * ```
 *
 ...
 * import * as scaleway from "@ediri/scaleway";
 *
 * const snapshotWithExpiration = new scaleway.RdbSnapshot("snapshotWithExpiration", {
 ...
 * import * as scaleway from "@ediri/scaleway";
 *
 * const snapshotA = new scaleway.RdbSnapshot("snapshotA", {instanceId: scaleway_rdb_instance.main.id}, {
 *     dependsOn: [scaleway_rdb_instance.main],
 * });
 * const snapshotB = new scaleway.RdbSnapshot("snapshotB", {
 *     instanceId: scaleway_rdb_instance.main.id,
