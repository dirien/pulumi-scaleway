...
export interface DomainRegistrationAdministrativeContact {
     ...
     */
    extensionEu: outputs.DomainRegistrationAdministrativeContactExtensionEu;
    /**
     * Details specific to French domain extensions.
     */
    extensionFr: outputs.DomainRegistrationAdministrativeContactExtensionFr;
    /**
...
export interface DomainRegistrationAdministrativeContactExtensionFr {
     ...
     */
    associationInfo?: outputs.DomainRegistrationAdministrativeContactExtensionFrAssociationInfo;
    /**
     * AFNIC authorization information for the contact (French extension).
     */
    codeAuthAfnicInfo?: outputs.DomainRegistrationAdministrativeContactExtensionFrCodeAuthAfnicInfo;
    /**
     * DUNS information for the domain owner (specific to French domains).
     */
    dunsInfo?: outputs.DomainRegistrationAdministrativeContactExtensionFrDunsInfo;
    /**
     * Information about the individual registration for French domains.
     */
    individualInfo?: outputs.DomainRegistrationAdministrativeContactExtensionFrIndividualInfo;
    /**
     ...
     */
    trademarkInfo?: outputs.DomainRegistrationAdministrativeContactExtensionFrTrademarkInfo;
}
...
export interface DomainRegistrationDsRecord {
     ...
     */
    digests: outputs.DomainRegistrationDsRecordDigest[];
    /**
     ...
     */
    publicKeys: outputs.DomainRegistrationDsRecordPublicKey[];
}
...
export interface DomainRegistrationDsRecordDigest {
     ...
     */
    publicKeys: outputs.DomainRegistrationDsRecordDigestPublicKey[];
    /**
...
export interface DomainRegistrationOwnerContact {
     ...
     * Details specific to European domain extensions.
     */
    extensionEu: outputs.DomainRegistrationOwnerContactExtensionEu;
    /**
     * Details specific to French domain extensions.
     */
    extensionFr: outputs.DomainRegistrationOwnerContactExtensionFr;
    /**
     * Extension details specific to Dutch domain registrations.
     */
    extensionNls: string[];
...
export interface DomainRegistrationOwnerContactExtensionFr {
     ...
     * Association-specific information for the domain (French extension).
     */
    associationInfo?: outputs.DomainRegistrationOwnerContactExtensionFrAssociationInfo;
    /**
     * AFNIC authorization information for the contact (French extension).
     */
    codeAuthAfnicInfo?: outputs.DomainRegistrationOwnerContactExtensionFrCodeAuthAfnicInfo;
    /**
     * DUNS information for the domain owner (specific to French domains).
     */
    dunsInfo?: outputs.DomainRegistrationOwnerContactExtensionFrDunsInfo;
    /**
     * Information about the individual registration for French domains.
     */
    individualInfo?: outputs.DomainRegistrationOwnerContactExtensionFrIndividualInfo;
    /**
     * Mode of the French extension (e.g., 'individual', 'duns', 'association', etc.).
     */
    mode?: string;
     ...
     * Trademark-related information for the domain (French extension).
     */
    trademarkInfo?: outputs.DomainRegistrationOwnerContactExtensionFrTrademarkInfo;
}
...
export interface DomainRegistrationTechnicalContact {
     ...
     * Details specific to European domain extensions.
     */
    extensionEu: outputs.DomainRegistrationTechnicalContactExtensionEu;
    /**
     * Details specific to French domain extensions.
     */
    extensionFr: outputs.DomainRegistrationTechnicalContactExtensionFr;
    /**
     * Extension details specific to Dutch domain registrations.
     */
    extensionNls: string[];
...
export interface DomainRegistrationTechnicalContactExtensionFr {
     ...
     * Association-specific information for the domain (French extension).
     */
    associationInfo?: outputs.DomainRegistrationTechnicalContactExtensionFrAssociationInfo;
    /**
     * AFNIC authorization information for the contact (French extension).
     */
    codeAuthAfnicInfo?: outputs.DomainRegistrationTechnicalContactExtensionFrCodeAuthAfnicInfo;
    /**
     * DUNS information for the domain owner (specific to French domains).
     */
    dunsInfo?: outputs.DomainRegistrationTechnicalContactExtensionFrDunsInfo;
    /**
     * Information about the individual registration for French domains.
     */
    individualInfo?: outputs.DomainRegistrationTechnicalContactExtensionFrIndividualInfo;
    /**
     * Mode of the French extension (e.g., 'individual', 'duns', 'association', etc.).
     */
    mode?: string;
     ...
     * Trademark-related information for the domain (French extension).
     */
    trademarkInfo?: outputs.DomainRegistrationTechnicalContactExtensionFrTrademarkInfo;
}
...
export interface GetAccountProjectsProject {
    /**
...
export interface GetInferenceModelNodesSupport {
    /**
     ...
     */
    quantizations: outputs.GetInferenceModelNodesSupportQuantization[];
}

export interface GetInferenceModelNodesSupportQuantization {
    /**
...
export interface GetK8sPoolNode {
     ...
     */
    privateIps: outputs.GetK8sPoolNodePrivateIp[];
    /**
     * The public IPv4.
     */
    publicIp: string;
...
export interface GetK8sPoolNodePrivateIp {
    /**
     * The private IP address
     */
    address: string;
...
export interface GetLbPrivateIp {
    /**
     * The private IP address
     */
    address: string;
...
export interface GetRdbInstancePrivateIp {
    /**
     * The private IPv4 address
     */
    address: string;
...
export interface GetWebhostingOfferOffer {
    /**
     ...
     */
    options: outputs.GetWebhostingOfferOfferOption[];
    /**
     * The offer price.
     */
    price: string;
...
export interface GetWebhostingOfferOfferOption {
    /**
     * The billing operation identifier for the option.
     */
    billingOperationPath: string;
...
export interface InferenceModelNodesSupport {
     ...
     * A list of supported quantization options, including:
     */
    quantizations: outputs.InferenceModelNodesSupportQuantization[];
}
...
export interface K8sAclAclRule {
    /**
...
export interface K8sPoolNode {
     ...
     */
    privateIps: outputs.K8sPoolNodePrivateIp[];
    /**
...
export interface K8sPoolNodePrivateIp {
    /**
     * The private IP address.
     */
    address: string;
