 ...
 * const snsCredentials = new scaleway.MnqSnsCredentials("snsCredentials", {permissions: {
 *     canManage: true,
 * }});
 * const snsTopic = new scaleway.MnqSnsTopic("snsTopic", {
 *     accessKey: snsCredentials.accessKey,
 *     secretKey: snsCredentials.secretKey,
 * });
 * const cr01 = new scaleway.TemDomain("cr01", {acceptTos: true});
