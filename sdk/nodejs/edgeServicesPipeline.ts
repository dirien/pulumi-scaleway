 ...
 *
 * const main = new scaleway.EdgeServicesPipeline("main", {description: "pipeline description"});
 * ```
 *
 * ### Complete pipeline
 *
 ...
 * import * as scaleway from "@ediri/scaleway";
 *
 * const mainEdgeServicesPipeline = new scaleway.EdgeServicesPipeline("mainEdgeServicesPipeline", {description: "pipeline description"});
 * const mainEdgeServicesBackendStage = new scaleway.EdgeServicesBackendStage("mainEdgeServicesBackendStage", {
 ...
 *     },
 * });
 * const mainEdgeServicesWafStage = new scaleway.EdgeServicesWafStage("mainEdgeServicesWafStage", {
 *     pipelineId: mainEdgeServicesPipeline.id,
 *     backendStageId: mainEdgeServicesBackendStage.id,
 *     mode: "enable",
 *     paranoiaLevel: 3,
 * });
 * const mainEdgeServicesRouteStage = new scaleway.EdgeServicesRouteStage("mainEdgeServicesRouteStage", {
 *     pipelineId: mainEdgeServicesPipeline.id,
 ...
 *     }],
 * });
 * const mainEdgeServicesCacheStage = new scaleway.EdgeServicesCacheStage("mainEdgeServicesCacheStage", {
 *     pipelineId: mainEdgeServicesPipeline.id,
 *     routeStageId: mainEdgeServicesRouteStage.id,
 * });
 * const mainEdgeServicesTlsStage = new scaleway.EdgeServicesTlsStage("mainEdgeServicesTlsStage", {
 *     pipelineId: mainEdgeServicesPipeline.id,
 *     cacheStageId: mainEdgeServicesCacheStage.id,
 *     managedCertificate: true,
 * });
 * const mainEdgeServicesDnsStage = new scaleway.EdgeServicesDnsStage("mainEdgeServicesDnsStage", {
 *     pipelineId: mainEdgeServicesPipeline.id,
 *     tlsStageId: mainEdgeServicesTlsStage.id,
 *     fqdns: ["subdomain.example.com"],
 * });
 * const mainEdgeServicesHeadStage = new scaleway.EdgeServicesHeadStage("mainEdgeServicesHeadStage", {
 *     pipelineId: mainEdgeServicesPipeline.id,
