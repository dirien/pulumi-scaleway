 ...
 *
 * const testObjectBucket = new scaleway.ObjectBucket("testObjectBucket", {acl: "public-read"});
 * const someFile = new scaleway.ObjectItem("someFile", {
 ...
 * });
 * const testObjectBucketWebsiteConfiguration = new scaleway.ObjectBucketWebsiteConfiguration("testObjectBucketWebsiteConfiguration", {
 *     bucket: testObjectBucket.name,
 *     indexDocument: {
 *         suffix: "index.html",
 *     },
