...
export class InstanceVolume extends pulumi.CustomResource {
     ...
     *
     * > **Important:** Volumes with type `bSsd` (Block SSD) are deprecated and cannot be managed using the `scaleway.InstanceVolume` resource anymore. Please use the `scaleway.BlockVolume` resource instead.
