...
export { DomainRegistrationArgs, DomainRegistrationState } from "./domainRegistration";
export type DomainRegistration = import("./domainRegistration").DomainRegistration;
export const DomainRegistration: typeof import("./domainRegistration").DomainRegistration = null as any;
utilities.lazyLoad(exports, ["DomainRegistration"], () => require("./domainRegistration"));
...
export { GetAccountProjectsArgs, GetAccountProjectsResult, GetAccountProjectsOutputArgs } from "./getAccountProjects";
export const getAccountProjects: typeof import("./getAccountProjects").getAccountProjects = null as any;
export const getAccountProjectsOutput: typeof import("./getAccountProjects").getAccountProjectsOutput = null as any;
utilities.lazyLoad(exports, ["getAccountProjects","getAccountProjectsOutput"], () => require("./getAccountProjects"));
...
export { GetBaremetalPartitionSchemaArgs, GetBaremetalPartitionSchemaResult, GetBaremetalPartitionSchemaOutputArgs } from "./getBaremetalPartitionSchema";
export const getBaremetalPartitionSchema: typeof import("./getBaremetalPartitionSchema").getBaremetalPartitionSchema = null as any;
export const getBaremetalPartitionSchemaOutput: typeof import("./getBaremetalPartitionSchema").getBaremetalPartitionSchemaOutput = null as any;
utilities.lazyLoad(exports, ["getBaremetalPartitionSchema","getBaremetalPartitionSchemaOutput"], () => require("./getBaremetalPartitionSchema"));
...
export { GetInferenceModelArgs, GetInferenceModelResult, GetInferenceModelOutputArgs } from "./getInferenceModel";
export const getInferenceModel: typeof import("./getInferenceModel").getInferenceModel = null as any;
export const getInferenceModelOutput: typeof import("./getInferenceModel").getInferenceModelOutput = null as any;
utilities.lazyLoad(exports, ["getInferenceModel","getInferenceModelOutput"], () => require("./getInferenceModel"));
...
export { GetTemOfferSubscriptionArgs, GetTemOfferSubscriptionResult, GetTemOfferSubscriptionOutputArgs } from "./getTemOfferSubscription";
export const getTemOfferSubscription: typeof import("./getTemOfferSubscription").getTemOfferSubscription = null as any;
export const getTemOfferSubscriptionOutput: typeof import("./getTemOfferSubscription").getTemOfferSubscriptionOutput = null as any;
utilities.lazyLoad(exports, ["getTemOfferSubscription","getTemOfferSubscriptionOutput"], () => require("./getTemOfferSubscription"));
...
export { InferenceModelArgs, InferenceModelState } from "./inferenceModel";
export type InferenceModel = import("./inferenceModel").InferenceModel;
export const InferenceModel: typeof import("./inferenceModel").InferenceModel = null as any;
utilities.lazyLoad(exports, ["InferenceModel"], () => require("./inferenceModel"));
...
export { K8sAclArgs, K8sAclState } from "./k8sAcl";
export type K8sAcl = import("./k8sAcl").K8sAcl;
export const K8sAcl: typeof import("./k8sAcl").K8sAcl = null as any;
utilities.lazyLoad(exports, ["K8sAcl"], () => require("./k8sAcl"));
...
export { TemBlockedListArgs, TemBlockedListState } from "./temBlockedList";
export type TemBlockedList = import("./temBlockedList").TemBlockedList;
export const TemBlockedList: typeof import("./temBlockedList").TemBlockedList = null as any;
utilities.lazyLoad(exports, ["TemBlockedList"], () => require("./temBlockedList"));
...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            ...
            case "scaleway:index/domainRegistration:DomainRegistration":
                return new DomainRegistration(name, <any>undefined, { urn })
            ...
            case "scaleway:index/inferenceModel:InferenceModel":
                return new InferenceModel(name, <any>undefined, { urn })
            ...
            case "scaleway:index/k8sAcl:K8sAcl":
                return new K8sAcl(name, <any>undefined, { urn })
            ...
            case "scaleway:index/temBlockedList:TemBlockedList":
                return new TemBlockedList(name, <any>undefined, { urn })
            ...
            case "scaleway:index/vpcAcl:VpcAcl":
...
pulumi.runtime.registerResourceModule("scaleway", "index/domainRegistration", _module)
...
pulumi.runtime.registerResourceModule("scaleway", "index/inferenceModel", _module)
...
pulumi.runtime.registerResourceModule("scaleway", "index/k8sAcl", _module)
...
pulumi.runtime.registerResourceModule("scaleway", "index/temBlockedList", _module)
...
pulumi.runtime.registerResourceModule("scaleway", "index/vpcAcl", _module)
