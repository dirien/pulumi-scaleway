...
namespace ediri.Scaleway
{
    ...
    public partial class InstanceVolume : global::Pulumi.CustomResource
    {
        ...
        /// 
        /// &gt; **Important:** Volumes with type `b_ssd` (Block SSD) are deprecated and cannot be managed using the `scaleway.InstanceVolume` resource anymore. Please use the `scaleway.BlockVolume` resource instead.
