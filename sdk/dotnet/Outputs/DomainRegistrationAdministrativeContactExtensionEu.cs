...
namespace ediri.Scaleway.Outputs
{
    ...
    [OutputType]
    public sealed class DomainRegistrationAdministrativeContactExtensionEu
    {
        /// <summary>
        ...
        [OutputConstructor]
        private DomainRegistrationAdministrativeContactExtensionEu(string? europeanCitizenship)
        {
