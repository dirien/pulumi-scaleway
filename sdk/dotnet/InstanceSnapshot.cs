...
namespace ediri.Scaleway
{
    ...
    public partial class InstanceSnapshot : global::Pulumi.CustomResource
    {
        ...
        /// 
        /// &gt; **Important:** Snapshots of volumes with type `b_ssd` (Block SSD) are deprecated and cannot be managed using the `scaleway.InstanceSnapshot` resource anymore. Please use the `scaleway.BlockSnapshot` resource instead.
