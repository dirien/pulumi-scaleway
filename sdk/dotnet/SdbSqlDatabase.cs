...
namespace ediri.Scaleway
{
    ...
    /// {
    ///     var database = new Scaleway.SdbSqlDatabase("database", new()
    ///     {
    ///         MaxCpu = 8,
    ///         MinCpu = 0,
    ///     });
    ...
    /// ```
    /// </summary>
    [ScalewayResourceType("scaleway:index/sdbSqlDatabase:SdbSqlDatabase")]
    public partial class SdbSqlDatabase : global::Pulumi.CustomResource
    {
        ...
        public SdbSqlDatabase(string name, SdbSqlDatabaseArgs? args = null, CustomResourceOptions? options = null)
            : base("scaleway:index/sdbSqlDatabase:SdbSqlDatabase", name, args ?? new SdbSqlDatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SdbSqlDatabase(string name, Input<string> id, SdbSqlDatabaseState? state = null, CustomResourceOptions? options = null)
            : base("scaleway:index/sdbSqlDatabase:SdbSqlDatabase", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static SdbSqlDatabase Get(string name, Input<string> id, SdbSqlDatabaseState? state = null, CustomResourceOptions? options = null)
        {
            return new SdbSqlDatabase(name, id, state, options);
        }
    }

    public sealed class SdbSqlDatabaseArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The maximum number of CPU units for your database. Defaults to 15.
        /// </summary>
        ...
        public SdbSqlDatabaseArgs()
        {
        }
        public static new SdbSqlDatabaseArgs Empty => new SdbSqlDatabaseArgs();
    }
    ...
    public sealed class SdbSqlDatabaseState : global::Pulumi.ResourceArgs
    {
        ...
        public SdbSqlDatabaseState()
        {
        }
        public static new SdbSqlDatabaseState Empty => new SdbSqlDatabaseState();
    }
}
