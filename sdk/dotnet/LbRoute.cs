...
namespace ediri.Scaleway
{
    ...
    /// return await Deployment.RunAsync(() =&gt; 
    /// {
    ///     var ip = new Scaleway.LbIp("ip");
    /// 
    ///     var lb = new Scaleway.Lb("lb", new()
    ///     {
    ///         IpId = ip.Id,
    ///         Type = "lb-s",
    ///     });
    /// 
    ///     var app = new Scaleway.LbBackend("app", new()
    ///     {
    ///         LbId = lb.Id,
    ///         ForwardProtocol = "http",
    ///         ForwardPort = 80,
    ...
    ///     });
    /// 
    ///     var admin = new Scaleway.LbBackend("admin", new()
    ///     {
    ///         LbId = lb.Id,
    ///         ForwardProtocol = "http",
    ///         ForwardPort = 8080,
    ...
    ///     });
    /// 
    ///     var frontend = new Scaleway.LbFrontend("frontend", new()
    ///     {
    ///         LbId = lb.Id,
    ///         BackendId = app.Id,
    ///         InboundPort = 80,
    ///     });
    /// 
    ///     var adminRoute = new Scaleway.LbRoute("adminRoute", new()
    ///     {
    ...
    ///     });
    /// 
    ///     var defaultRoute = new Scaleway.LbRoute("defaultRoute", new()
    ///     {
    ///         FrontendId = frontend.Id,
    ///         BackendId = app.Id,
    ///         MatchPathBegin = "/",
