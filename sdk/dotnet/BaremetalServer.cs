...
namespace ediri.Scaleway
{
    ...
    ///     });
    /// 
    ///     var myServer = new Scaleway.BaremetalServer("myServer", new()
    ///     {
    ///         Zone = "fr-par-2",
    ...
    ///     });
    /// 
    ///     var mySshKey = new Scaleway.IamSshKey("mySshKey", new()
    ///     {
    ...
    /// You cannot directly modify the subscription_period of an existing scaleway.getBaremetalOffer resource. Instead, you must define the monthly offer using the data source and then update the server configuration accordingly.
    /// 
    /// ### Hourly Plan Example
    /// 
    /// ```csharp
    ...
    public partial class BaremetalServer : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("privateIps")]
        public Output<ImmutableArray<Outputs.BaremetalServerPrivateIp>> PrivateIps { get; private set; } = null!;
    ...
    public sealed class BaremetalServerState : global::Pulumi.ResourceArgs
    {
        ...
        /// The list of private IPv4 and IPv6 addresses associated with the resource.
        /// </summary>
        public InputList<Inputs.BaremetalServerPrivateIpGetArgs> PrivateIps
        {
            get => _privateIps ?? (_privateIps = new InputList<Inputs.BaremetalServerPrivateIpGetArgs>());
            set => _privateIps = value;
        }
