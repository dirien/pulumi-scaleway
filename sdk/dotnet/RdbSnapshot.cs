...
namespace ediri.Scaleway
{
    ...
    /// return await Deployment.RunAsync(() =&gt; 
    /// {
    ///     var snapshotWithExpiration = new Scaleway.RdbSnapshot("snapshotWithExpiration", new()
    ///     {
    ...
    /// return await Deployment.RunAsync(() =&gt; 
    /// {
    ///     var snapshotA = new Scaleway.RdbSnapshot("snapshotA", new()
    ///     {
    ///         InstanceId = scaleway_rdb_instance.Main.Id,
    ///     }, new CustomResourceOptions
    ///     {
    ...
    ///     });
    /// 
    ///     var snapshotB = new Scaleway.RdbSnapshot("snapshotB", new()
    ///     {
    ///         InstanceId = scaleway_rdb_instance.Main.Id,
