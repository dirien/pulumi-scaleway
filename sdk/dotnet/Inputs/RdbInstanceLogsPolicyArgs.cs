...
namespace ediri.Scaleway.Inputs
{
    ...
    public sealed class RdbInstanceLogsPolicyArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public RdbInstanceLogsPolicyArgs()
        {
        }
        public static new RdbInstanceLogsPolicyArgs Empty => new RdbInstanceLogsPolicyArgs();
    }
}
