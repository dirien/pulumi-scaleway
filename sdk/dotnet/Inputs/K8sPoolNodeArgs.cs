...
namespace ediri.Scaleway.Inputs
{
    ...
    public sealed class K8sPoolNodeArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("privateIps")]
        private InputList<Inputs.K8sPoolNodePrivateIpArgs>? _privateIps;

        /// <summary>
        /// The list of private IPv4 and IPv6 addresses associated with the node.
        /// </summary>
        public InputList<Inputs.K8sPoolNodePrivateIpArgs> PrivateIps
        {
            get => _privateIps ?? (_privateIps = new InputList<Inputs.K8sPoolNodePrivateIpArgs>());
