...
namespace ediri.Scaleway.Inputs
{
    ...
    public sealed class DomainRegistrationOwnerContactArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("extensionEu")]
        public Input<Inputs.DomainRegistrationOwnerContactExtensionEuArgs>? ExtensionEu { get; set; }

        /// <summary>
        /// Details specific to French domain extensions.
        /// </summary>
        [Input("extensionFr")]
        public Input<Inputs.DomainRegistrationOwnerContactExtensionFrArgs>? ExtensionFr { get; set; }
        ...
        public DomainRegistrationOwnerContactArgs()
        {
        }
        public static new DomainRegistrationOwnerContactArgs Empty => new DomainRegistrationOwnerContactArgs();
    }
}
