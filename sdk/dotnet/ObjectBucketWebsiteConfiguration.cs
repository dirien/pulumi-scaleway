...
namespace ediri.Scaleway
{
    ...
    /// {
    ///     var testObjectBucket = new Scaleway.ObjectBucket("testObjectBucket", new()
    ///     {
    ///         Acl = "public-read",
    ///     });
    /// 
    ///     var someFile = new Scaleway.ObjectItem("someFile", new()
    ///     {
    ...
    ///     });
    /// 
    ///     var testObjectBucketWebsiteConfiguration = new Scaleway.ObjectBucketWebsiteConfiguration("testObjectBucketWebsiteConfiguration", new()
    ///     {
    ///         Bucket = testObjectBucket.Name,
