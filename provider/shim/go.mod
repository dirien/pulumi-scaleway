module github.com/scaleway/terraform-provider-scaleway/v2/shim
...
require (
	...
	github.com/scaleway/terraform-provider-scaleway/v2 v2.56.0
)
...
require (
	...
	github.com/scaleway/scaleway-sdk-go v1.0.0-beta.33.0.20250613133518-6987cd48643b // indirect
