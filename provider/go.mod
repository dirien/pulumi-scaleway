...
replace github.com/pulumi/pulumi/pkg/v3 => github.com/pulumi/pulumi/pkg/v3 v3.99.0

require (
	github.com/pulumi/pulumi-terraform-bridge/v3 v3.71.0
	github.com/pulumi/pulumi/sdk/v3 v3.102.0
	github.com/scaleway/terraform-provider-scaleway/v2 v2.38.3
)
...
require (
	...
	github.com/scaleway/scaleway-sdk-go v1.0.0-beta.25.0.20240325161646-a49fad6abe89 // indirect
