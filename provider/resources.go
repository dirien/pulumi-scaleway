...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		Resources: map[string]*tfbridge.ResourceInfo{
			...
			"scaleway_document_db_database":                 {Tok: tfbridge.MakeResource(mainPkg, mainMod, "DocumentDBDatabase")},
			"scaleway_document_db_instance":                 {Tok: tfbridge.MakeResource(mainPkg, mainMod, "DocumentDBInstance")},
			"scaleway_document_db_private_network_endpoint": {Tok: tfbridge.MakeResource(mainPkg, mainMod, "DocumentDBPrivateNetworkEndpoint")},
			"scaleway_document_db_privilege":                {Tok: tfbridge.MakeResource(mainPkg, mainMod, "DocumentDBPrivilege")},
			"scaleway_document_db_read_replica":             {Tok: tfbridge.MakeResource(mainPkg, mainMod, "DocumentDBReadReplica")},
			"scaleway_document_db_user":                     {Tok: tfbridge.MakeResource(mainPkg, mainMod, "DocumentDBUser")},
		},
		DataSources: map[string]*tfbridge.DataSourceInfo{
			...
			"scaleway_document_db_database":                {Tok: tfbridge.MakeDataSource(mainPkg, mainMod, "getDocumentDBDatabase")},
			"scaleway_document_db_instance":                {Tok: tfbridge.MakeDataSource(mainPkg, mainMod, "getDocumentDBInstance")},
			"scaleway_document_db_load_balancer_endpoint":  {Tok: tfbridge.MakeDataSource(mainPkg, mainMod, "getDocumentDBLoadBalancerEndpoint")},
		},
